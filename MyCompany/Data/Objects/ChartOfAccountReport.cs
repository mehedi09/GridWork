...
namespace MyCompany.Data.Objects
{
    ...
    public partial class ChartOfAccountReport
    {
        ...
        public static List<MyCompany.Data.Objects.ChartOfAccountReport> Select(
                    int? coaDetailID, 
                    int? accFundID, 
                    ...
                    string bankAccType)
        {
            return new ChartOfAccountReportFactory().Select(coaDetailID, accFundID, accFundAccFundName, accFundCode, acccode, accName, accDesc, accTypeID, accTypeAccType, accDestID, accDestAccDest, accDestCompanyTypeDescription, accBalTypeID, accBalTypeAccBalType, accCurrency, accCurrencyAccCurrencyName, consTranCode, coaControlID, coaControlAccName, coaControlAccBalTypeAccBalType, coaControlAccDestAccDest, coaControlAccDestCompanyTypeDescription, coaControlAccTypeAccType, coaControlCompTypeDescription, coaSubID, coaSubAccName, coaSubAccBalTypeAccBalType, coaSubAccDestAccDest, coaSubAccDestCompanyTypeDescription, coaSubAccFundAccFundName, coaSubAccTypeAccType, coaSubCoaControlAccName, coaSubCoaControlAccBalTypeAccBalType, coaSubCoaControlAccDestAccDest, coaSubCoaControlAccTypeAccType, coaSubCoaControlCompTypeDescription, coaSubCoaMainAccName, coaSubCoaMainAccBalTypeAccBalType, coaSubCoaMainAccDestAccDest, coaSubCoaMainAccFundAccFundName, coaSubCoaMainAccTypeAccType, coaSubCoaMainCoaControlAccName, coaMainID, coaMainAccName, coaMainAccBalTypeAccBalType, coaMainAccDestAccDest, coaMainAccDestCompanyTypeDescription, coaMainAccFundAccFundName, coaMainAccTypeAccType, coaMainCoaControlAccName, coaMainCoaControlAccBalTypeAccBalType, coaMainCoaControlAccDestAccDest, coaMainCoaControlAccTypeAccType, coaMainCoaControlCompTypeDescription, tranCode, subsYN, accSubTypeID, accSubTypeAccSubTypeName, openDate, openDebit, openCredit, accCurrencyRate, revenue, variableCost, monthlyExp, budget, annex, dlt, isCashNature, isBankNature, accSubTypeID1, accSubTypeID2, bankName, bankAccNum, branchName, bankAccType);
        }
        
        public static List<MyCompany.Data.Objects.ChartOfAccountReport> Select(MyCompany.Data.Objects.ChartOfAccountReport qbe)
        {
            return new ChartOfAccountReportFactory().Select(qbe);
        }
        
        public static List<MyCompany.Data.Objects.ChartOfAccountReport> Select(string filter, string sort, string dataView, BusinessObjectParameters parameters)
        {
            return new ChartOfAccountReportFactory().Select(filter, sort, dataView, parameters);
        }
        
        public static List<MyCompany.Data.Objects.ChartOfAccountReport> Select(string filter, string sort, string dataView, params FieldValue[] parameters)
        {
            return new ChartOfAccountReportFactory().Select(filter, sort, dataView, new BusinessObjectParameters(parameters));
        }
        
        public static List<MyCompany.Data.Objects.ChartOfAccountReport> Select(string filter, string sort, BusinessObjectParameters parameters)
        {
            return new ChartOfAccountReportFactory().Select(filter, sort, ChartOfAccountReportFactory.SelectView, parameters);
        }
        
        public static List<MyCompany.Data.Objects.ChartOfAccountReport> Select(string filter, string sort, params FieldValue[] parameters)
        {
            return new ChartOfAccountReportFactory().Select(filter, sort, ChartOfAccountReportFactory.SelectView, new BusinessObjectParameters(parameters));
        }
        
        public static List<MyCompany.Data.Objects.ChartOfAccountReport> Select(string filter, BusinessObjectParameters parameters)
        {
            return new ChartOfAccountReportFactory().Select(filter, null, ChartOfAccountReportFactory.SelectView, parameters);
        }
        
        public static List<MyCompany.Data.Objects.ChartOfAccountReport> Select(string filter, params FieldValue[] parameters)
        {
            return new ChartOfAccountReportFactory().Select(filter, null, ChartOfAccountReportFactory.SelectView, new BusinessObjectParameters(parameters));
        }
        
        public static MyCompany.Data.Objects.ChartOfAccountReport SelectSingle(string filter, BusinessObjectParameters parameters)
        {
            return new ChartOfAccountReportFactory().SelectSingle(filter, parameters);
        }
        
        public static MyCompany.Data.Objects.ChartOfAccountReport SelectSingle(string filter, params FieldValue[] parameters)
        {
            return new ChartOfAccountReportFactory().SelectSingle(filter, new BusinessObjectParameters(parameters));
        }
        
        public static MyCompany.Data.Objects.ChartOfAccountReport SelectSingle(int? coaDetailID)
        {
            return new ChartOfAccountReportFactory().SelectSingle(coaDetailID);
        }
        
        public int Insert()
        {
            return new ChartOfAccountReportFactory().Insert(this);
        }
        
        public int Update()
        {
            return new ChartOfAccountReportFactory().Update(this);
        }
        
        public int Delete()
        {
            return new ChartOfAccountReportFactory().Delete(this);
        }
    ...
    public partial class ChartOfAccountReportFactory
    {
        
        public ChartOfAccountReportFactory()
        {
        }
        ...
        public static string SelectView
        {
            get
            {
                return Controller.GetSelectView("ChartOfAccountReport");
            }
        }
        ...
        public static string InsertView
        {
            get
            {
                return Controller.GetInsertView("ChartOfAccountReport");
            }
        }
        ...
        public static string UpdateView
        {
            get
            {
                return Controller.GetUpdateView("ChartOfAccountReport");
            }
        }
        ...
        public static string DeleteView
        {
            get
            {
                return Controller.GetDeleteView("ChartOfAccountReport");
            }
        }
        
        public static ChartOfAccountReportFactory Create()
        {
            return new ChartOfAccountReportFactory();
        }
        ...
        public List<MyCompany.Data.Objects.ChartOfAccountReport> Select(
                    int? coaDetailID, 
                    int? accFundID, 
                    string accFundAccFundName, 
                    string accFundCode, 
                    ...
                    string dataView)
        {
            ...
            ViewPage page = ControllerFactory.CreateDataController().GetPage("ChartOfAccountReport", dataView, request);
            return page.ToList<MyCompany.Data.Objects.ChartOfAccountReport>();
        }
        
        public List<MyCompany.Data.Objects.ChartOfAccountReport> Select(MyCompany.Data.Objects.ChartOfAccountReport qbe)
        {
        ...
        public MyCompany.Data.Objects.ChartOfAccountReport SelectSingle(int? coaDetailID)
        {
            List<MyCompany.Data.Objects.ChartOfAccountReport> list = Select(coaDetailID, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
            if (list.Count == 0)
            	return null;
            return list[0];
        }
        
        public List<MyCompany.Data.Objects.ChartOfAccountReport> Select(string filter, string sort, string dataView, BusinessObjectParameters parameters)
        {
            ...
            ViewPage page = c.GetPage("ChartOfAccountReport", dataView, request);
            return page.ToList<MyCompany.Data.Objects.ChartOfAccountReport>();
        }
        
        public List<MyCompany.Data.Objects.ChartOfAccountReport> SelectSingle(string filter, string sort, BusinessObjectParameters parameters)
        {
            return Select(filter, sort, SelectView, parameters);
        }
        
        public List<MyCompany.Data.Objects.ChartOfAccountReport> Select(string filter, BusinessObjectParameters parameters)
        {
            return Select(filter, null, SelectView, parameters);
        }
        
        public MyCompany.Data.Objects.ChartOfAccountReport SelectSingle(string filter, BusinessObjectParameters parameters)
        {
            List<MyCompany.Data.Objects.ChartOfAccountReport> list = Select(filter, parameters);
            if (list.Count > 0)
            	return list[0];
            return null;
        }
        
        protected virtual FieldValue[] CreateFieldValues(MyCompany.Data.Objects.ChartOfAccountReport theChartOfAccountReport, MyCompany.Data.Objects.ChartOfAccountReport original_ChartOfAccountReport)
        {
            List<FieldValue> values = new List<FieldValue>();
            values.Add(new FieldValue("CoaDetailID", original_ChartOfAccountReport.CoaDetailID, theChartOfAccountReport.CoaDetailID, true));
            values.Add(new FieldValue("AccFundID", original_ChartOfAccountReport.AccFundID, theChartOfAccountReport.AccFundID));
            values.Add(new FieldValue("AccFundAccFundName", original_ChartOfAccountReport.AccFundAccFundName, theChartOfAccountReport.AccFundAccFundName, true));
            values.Add(new FieldValue("AccFundCode", original_ChartOfAccountReport.AccFundCode, theChartOfAccountReport.AccFundCode));
            values.Add(new FieldValue("Acccode", original_ChartOfAccountReport.Acccode, theChartOfAccountReport.Acccode));
            values.Add(new FieldValue("AccName", original_ChartOfAccountReport.AccName, theChartOfAccountReport.AccName));
            values.Add(new FieldValue("AccDesc", original_ChartOfAccountReport.AccDesc, theChartOfAccountReport.AccDesc));
            values.Add(new FieldValue("AccTypeID", original_ChartOfAccountReport.AccTypeID, theChartOfAccountReport.AccTypeID));
            values.Add(new FieldValue("AccTypeAccType", original_ChartOfAccountReport.AccTypeAccType, theChartOfAccountReport.AccTypeAccType, true));
            values.Add(new FieldValue("AccDestID", original_ChartOfAccountReport.AccDestID, theChartOfAccountReport.AccDestID));
            values.Add(new FieldValue("AccDestAccDest", original_ChartOfAccountReport.AccDestAccDest, theChartOfAccountReport.AccDestAccDest, true));
            values.Add(new FieldValue("AccDestCompanyTypeDescription", original_ChartOfAccountReport.AccDestCompanyTypeDescription, theChartOfAccountReport.AccDestCompanyTypeDescription, true));
            values.Add(new FieldValue("AccBalTypeID", original_ChartOfAccountReport.AccBalTypeID, theChartOfAccountReport.AccBalTypeID));
            values.Add(new FieldValue("AccBalTypeAccBalType", original_ChartOfAccountReport.AccBalTypeAccBalType, theChartOfAccountReport.AccBalTypeAccBalType, true));
            values.Add(new FieldValue("AccCurrency", original_ChartOfAccountReport.AccCurrency, theChartOfAccountReport.AccCurrency));
            values.Add(new FieldValue("AccCurrencyAccCurrencyName", original_ChartOfAccountReport.AccCurrencyAccCurrencyName, theChartOfAccountReport.AccCurrencyAccCurrencyName, true));
            values.Add(new FieldValue("ConsTranCode", original_ChartOfAccountReport.ConsTranCode, theChartOfAccountReport.ConsTranCode));
            values.Add(new FieldValue("CoaControlID", original_ChartOfAccountReport.CoaControlID, theChartOfAccountReport.CoaControlID));
            values.Add(new FieldValue("CoaControlAccName", original_ChartOfAccountReport.CoaControlAccName, theChartOfAccountReport.CoaControlAccName, true));
            values.Add(new FieldValue("CoaControlAccBalTypeAccBalType", original_ChartOfAccountReport.CoaControlAccBalTypeAccBalType, theChartOfAccountReport.CoaControlAccBalTypeAccBalType, true));
            values.Add(new FieldValue("CoaControlAccDestAccDest", original_ChartOfAccountReport.CoaControlAccDestAccDest, theChartOfAccountReport.CoaControlAccDestAccDest, true));
            values.Add(new FieldValue("CoaControlAccDestCompanyTypeDescription", original_ChartOfAccountReport.CoaControlAccDestCompanyTypeDescription, theChartOfAccountReport.CoaControlAccDestCompanyTypeDescription, true));
            values.Add(new FieldValue("CoaControlAccTypeAccType", original_ChartOfAccountReport.CoaControlAccTypeAccType, theChartOfAccountReport.CoaControlAccTypeAccType, true));
            values.Add(new FieldValue("CoaControlCompTypeDescription", original_ChartOfAccountReport.CoaControlCompTypeDescription, theChartOfAccountReport.CoaControlCompTypeDescription, true));
            values.Add(new FieldValue("CoaSubID", original_ChartOfAccountReport.CoaSubID, theChartOfAccountReport.CoaSubID));
            values.Add(new FieldValue("CoaSubAccName", original_ChartOfAccountReport.CoaSubAccName, theChartOfAccountReport.CoaSubAccName, true));
            values.Add(new FieldValue("CoaSubAccBalTypeAccBalType", original_ChartOfAccountReport.CoaSubAccBalTypeAccBalType, theChartOfAccountReport.CoaSubAccBalTypeAccBalType, true));
            values.Add(new FieldValue("CoaSubAccDestAccDest", original_ChartOfAccountReport.CoaSubAccDestAccDest, theChartOfAccountReport.CoaSubAccDestAccDest, true));
            values.Add(new FieldValue("CoaSubAccDestCompanyTypeDescription", original_ChartOfAccountReport.CoaSubAccDestCompanyTypeDescription, theChartOfAccountReport.CoaSubAccDestCompanyTypeDescription, true));
            values.Add(new FieldValue("CoaSubAccFundAccFundName", original_ChartOfAccountReport.CoaSubAccFundAccFundName, theChartOfAccountReport.CoaSubAccFundAccFundName, true));
            values.Add(new FieldValue("CoaSubAccTypeAccType", original_ChartOfAccountReport.CoaSubAccTypeAccType, theChartOfAccountReport.CoaSubAccTypeAccType, true));
            values.Add(new FieldValue("CoaSubCoaControlAccName", original_ChartOfAccountReport.CoaSubCoaControlAccName, theChartOfAccountReport.CoaSubCoaControlAccName, true));
            values.Add(new FieldValue("CoaSubCoaControlAccBalTypeAccBalType", original_ChartOfAccountReport.CoaSubCoaControlAccBalTypeAccBalType, theChartOfAccountReport.CoaSubCoaControlAccBalTypeAccBalType, true));
            values.Add(new FieldValue("CoaSubCoaControlAccDestAccDest", original_ChartOfAccountReport.CoaSubCoaControlAccDestAccDest, theChartOfAccountReport.CoaSubCoaControlAccDestAccDest, true));
            values.Add(new FieldValue("CoaSubCoaControlAccTypeAccType", original_ChartOfAccountReport.CoaSubCoaControlAccTypeAccType, theChartOfAccountReport.CoaSubCoaControlAccTypeAccType, true));
            values.Add(new FieldValue("CoaSubCoaControlCompTypeDescription", original_ChartOfAccountReport.CoaSubCoaControlCompTypeDescription, theChartOfAccountReport.CoaSubCoaControlCompTypeDescription, true));
            values.Add(new FieldValue("CoaSubCoaMainAccName", original_ChartOfAccountReport.CoaSubCoaMainAccName, theChartOfAccountReport.CoaSubCoaMainAccName, true));
            values.Add(new FieldValue("CoaSubCoaMainAccBalTypeAccBalType", original_ChartOfAccountReport.CoaSubCoaMainAccBalTypeAccBalType, theChartOfAccountReport.CoaSubCoaMainAccBalTypeAccBalType, true));
            values.Add(new FieldValue("CoaSubCoaMainAccDestAccDest", original_ChartOfAccountReport.CoaSubCoaMainAccDestAccDest, theChartOfAccountReport.CoaSubCoaMainAccDestAccDest, true));
            values.Add(new FieldValue("CoaSubCoaMainAccFundAccFundName", original_ChartOfAccountReport.CoaSubCoaMainAccFundAccFundName, theChartOfAccountReport.CoaSubCoaMainAccFundAccFundName, true));
            values.Add(new FieldValue("CoaSubCoaMainAccTypeAccType", original_ChartOfAccountReport.CoaSubCoaMainAccTypeAccType, theChartOfAccountReport.CoaSubCoaMainAccTypeAccType, true));
            values.Add(new FieldValue("CoaSubCoaMainCoaControlAccName", original_ChartOfAccountReport.CoaSubCoaMainCoaControlAccName, theChartOfAccountReport.CoaSubCoaMainCoaControlAccName, true));
            values.Add(new FieldValue("CoaMainID", original_ChartOfAccountReport.CoaMainID, theChartOfAccountReport.CoaMainID));
            values.Add(new FieldValue("CoaMainAccName", original_ChartOfAccountReport.CoaMainAccName, theChartOfAccountReport.CoaMainAccName, true));
            values.Add(new FieldValue("CoaMainAccBalTypeAccBalType", original_ChartOfAccountReport.CoaMainAccBalTypeAccBalType, theChartOfAccountReport.CoaMainAccBalTypeAccBalType, true));
            values.Add(new FieldValue("CoaMainAccDestAccDest", original_ChartOfAccountReport.CoaMainAccDestAccDest, theChartOfAccountReport.CoaMainAccDestAccDest, true));
            values.Add(new FieldValue("CoaMainAccDestCompanyTypeDescription", original_ChartOfAccountReport.CoaMainAccDestCompanyTypeDescription, theChartOfAccountReport.CoaMainAccDestCompanyTypeDescription, true));
            values.Add(new FieldValue("CoaMainAccFundAccFundName", original_ChartOfAccountReport.CoaMainAccFundAccFundName, theChartOfAccountReport.CoaMainAccFundAccFundName, true));
            values.Add(new FieldValue("CoaMainAccTypeAccType", original_ChartOfAccountReport.CoaMainAccTypeAccType, theChartOfAccountReport.CoaMainAccTypeAccType, true));
            values.Add(new FieldValue("CoaMainCoaControlAccName", original_ChartOfAccountReport.CoaMainCoaControlAccName, theChartOfAccountReport.CoaMainCoaControlAccName, true));
            values.Add(new FieldValue("CoaMainCoaControlAccBalTypeAccBalType", original_ChartOfAccountReport.CoaMainCoaControlAccBalTypeAccBalType, theChartOfAccountReport.CoaMainCoaControlAccBalTypeAccBalType, true));
            values.Add(new FieldValue("CoaMainCoaControlAccDestAccDest", original_ChartOfAccountReport.CoaMainCoaControlAccDestAccDest, theChartOfAccountReport.CoaMainCoaControlAccDestAccDest, true));
            values.Add(new FieldValue("CoaMainCoaControlAccTypeAccType", original_ChartOfAccountReport.CoaMainCoaControlAccTypeAccType, theChartOfAccountReport.CoaMainCoaControlAccTypeAccType, true));
            values.Add(new FieldValue("CoaMainCoaControlCompTypeDescription", original_ChartOfAccountReport.CoaMainCoaControlCompTypeDescription, theChartOfAccountReport.CoaMainCoaControlCompTypeDescription, true));
            values.Add(new FieldValue("TranCode", original_ChartOfAccountReport.TranCode, theChartOfAccountReport.TranCode));
            values.Add(new FieldValue("SubsYN", original_ChartOfAccountReport.SubsYN, theChartOfAccountReport.SubsYN));
            values.Add(new FieldValue("AccSubTypeID", original_ChartOfAccountReport.AccSubTypeID, theChartOfAccountReport.AccSubTypeID));
            values.Add(new FieldValue("AccSubTypeAccSubTypeName", original_ChartOfAccountReport.AccSubTypeAccSubTypeName, theChartOfAccountReport.AccSubTypeAccSubTypeName, true));
            values.Add(new FieldValue("OpenDate", original_ChartOfAccountReport.OpenDate, theChartOfAccountReport.OpenDate));
            values.Add(new FieldValue("OpenDebit", original_ChartOfAccountReport.OpenDebit, theChartOfAccountReport.OpenDebit));
            values.Add(new FieldValue("OpenCredit", original_ChartOfAccountReport.OpenCredit, theChartOfAccountReport.OpenCredit));
            values.Add(new FieldValue("AccCurrencyRate", original_ChartOfAccountReport.AccCurrencyRate, theChartOfAccountReport.AccCurrencyRate));
            values.Add(new FieldValue("Revenue", original_ChartOfAccountReport.Revenue, theChartOfAccountReport.Revenue));
            values.Add(new FieldValue("VariableCost", original_ChartOfAccountReport.VariableCost, theChartOfAccountReport.VariableCost));
            values.Add(new FieldValue("MonthlyExp", original_ChartOfAccountReport.MonthlyExp, theChartOfAccountReport.MonthlyExp));
            values.Add(new FieldValue("Budget", original_ChartOfAccountReport.Budget, theChartOfAccountReport.Budget));
            values.Add(new FieldValue("Annex", original_ChartOfAccountReport.Annex, theChartOfAccountReport.Annex));
            values.Add(new FieldValue("Dlt", original_ChartOfAccountReport.Dlt, theChartOfAccountReport.Dlt));
            values.Add(new FieldValue("IsCashNature", original_ChartOfAccountReport.IsCashNature, theChartOfAccountReport.IsCashNature));
            values.Add(new FieldValue("IsBankNature", original_ChartOfAccountReport.IsBankNature, theChartOfAccountReport.IsBankNature));
            values.Add(new FieldValue("AccSubTypeID1", original_ChartOfAccountReport.AccSubTypeID1, theChartOfAccountReport.AccSubTypeID1));
            values.Add(new FieldValue("AccSubTypeID2", original_ChartOfAccountReport.AccSubTypeID2, theChartOfAccountReport.AccSubTypeID2));
            values.Add(new FieldValue("BankName", original_ChartOfAccountReport.BankName, theChartOfAccountReport.BankName));
            values.Add(new FieldValue("BankAccNum", original_ChartOfAccountReport.BankAccNum, theChartOfAccountReport.BankAccNum));
            values.Add(new FieldValue("BranchName", original_ChartOfAccountReport.BranchName, theChartOfAccountReport.BranchName));
            values.Add(new FieldValue("BankAccType", original_ChartOfAccountReport.BankAccType, theChartOfAccountReport.BankAccType));
            values.Add(new FieldValue("AccSubTypeAccSubTypeName1", original_ChartOfAccountReport.AccSubTypeAccSubTypeName1, theChartOfAccountReport.AccSubTypeAccSubTypeName1));
            values.Add(new FieldValue("AccSubTypeAccSubTypeName2", original_ChartOfAccountReport.AccSubTypeAccSubTypeName2, theChartOfAccountReport.AccSubTypeAccSubTypeName2));
            return values.ToArray();
        }
        
        protected virtual int ExecuteAction(MyCompany.Data.Objects.ChartOfAccountReport theChartOfAccountReport, MyCompany.Data.Objects.ChartOfAccountReport original_ChartOfAccountReport, string lastCommandName, string commandName, string dataView)
        {
            ActionArgs args = new ActionArgs();
            args.Controller = "ChartOfAccountReport";
            args.View = dataView;
            args.Values = CreateFieldValues(theChartOfAccountReport, original_ChartOfAccountReport);
            args.LastCommandName = lastCommandName;
            args.CommandName = commandName;
            ActionResult result = ControllerFactory.CreateDataController().Execute("ChartOfAccountReport", dataView, args);
            result.RaiseExceptionIfErrors();
            result.AssignTo(theChartOfAccountReport);
            return result.RowsAffected;
        }
        
        [System.ComponentModel.DataObjectMethod(System.ComponentModel.DataObjectMethodType.Update)]
        public virtual int Update(MyCompany.Data.Objects.ChartOfAccountReport theChartOfAccountReport, MyCompany.Data.Objects.ChartOfAccountReport original_ChartOfAccountReport)
        {
            return ExecuteAction(theChartOfAccountReport, original_ChartOfAccountReport, "Edit", "Update", UpdateView);
        }
        
        [System.ComponentModel.DataObjectMethod(System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(MyCompany.Data.Objects.ChartOfAccountReport theChartOfAccountReport)
        {
            return Update(theChartOfAccountReport, SelectSingle(theChartOfAccountReport.CoaDetailID));
        }
        
        [System.ComponentModel.DataObjectMethod(System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(MyCompany.Data.Objects.ChartOfAccountReport theChartOfAccountReport)
        {
            return ExecuteAction(theChartOfAccountReport, new ChartOfAccountReport(), "New", "Insert", InsertView);
        }
        
        [System.ComponentModel.DataObjectMethod(System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(MyCompany.Data.Objects.ChartOfAccountReport theChartOfAccountReport)
        {
            return ExecuteAction(theChartOfAccountReport, theChartOfAccountReport, "Select", "Delete", DeleteView);
        }
    }
}

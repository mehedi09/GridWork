...
namespace MyCompany.Data.Objects
{
    ...
    public partial class BillRegister
    {
        ...
        public static List<MyCompany.Data.Objects.BillRegister> Select(
                    int? billRegisterID, 
                    ...
                    string isPartialPay)
        {
            return new BillRegisterFactory().Select(billRegisterID, billRegisterNo, billDate, supplierID, supplierAccSubName, supplierAccSubTypeAccSubType, productDescription, reference, quantity, unitPrice, billAmount, accFundID, accFundAccFundName, projectID, paidAmount, vchrTranID, vchrTypeID, expenseHeadAccID, headAccID, headAccAccName, headAccAccBalTypeAccBalType, headAccAccCurrencyAccCurrencyName, headAccAccDestAccDest, headAccAccDestCompanyTypeDescription, headAccAccFundAccFundName, headAccAccSubTypeAccSubType, headAccAccTypeAccType, headAccCoaControlAccName, headAccCoaControlAccBalTypeAccBalType, headAccCoaControlAccDestAccDest, headAccCoaControlAccTypeAccType, headAccCoaControlCompTypeDescription, headAccCoaMainAccName, headAccCoaMainAccBalTypeAccBalType, headAccCoaMainAccDestAccDest, headAccCoaMainAccFundAccFundName, headAccCoaMainAccTypeAccType, headAccCoaMainCoaControlAccName, headAccCoaSubAccName, headAccCoaSubAccBalTypeAccBalType, headAccCoaSubAccDestAccDest, headAccCoaSubAccFundAccFundName, headAccCoaSubAccTypeAccType, headAccCoaSubCoaControlAccName, headAccCoaSubCoaMainAccName, revAccID, bankname, chequeNo, chequeDT, isPost, postDate, isPartialPay);
        }
        
        public static List<MyCompany.Data.Objects.BillRegister> Select(MyCompany.Data.Objects.BillRegister qbe)
        {
            return new BillRegisterFactory().Select(qbe);
        }
        
        public static List<MyCompany.Data.Objects.BillRegister> Select(string filter, string sort, string dataView, BusinessObjectParameters parameters)
        {
            return new BillRegisterFactory().Select(filter, sort, dataView, parameters);
        }
        
        public static List<MyCompany.Data.Objects.BillRegister> Select(string filter, string sort, string dataView, params FieldValue[] parameters)
        {
            return new BillRegisterFactory().Select(filter, sort, dataView, new BusinessObjectParameters(parameters));
        }
        
        public static List<MyCompany.Data.Objects.BillRegister> Select(string filter, string sort, BusinessObjectParameters parameters)
        {
            return new BillRegisterFactory().Select(filter, sort, BillRegisterFactory.SelectView, parameters);
        }
        
        public static List<MyCompany.Data.Objects.BillRegister> Select(string filter, string sort, params FieldValue[] parameters)
        {
            return new BillRegisterFactory().Select(filter, sort, BillRegisterFactory.SelectView, new BusinessObjectParameters(parameters));
        }
        
        public static List<MyCompany.Data.Objects.BillRegister> Select(string filter, BusinessObjectParameters parameters)
        {
            return new BillRegisterFactory().Select(filter, null, BillRegisterFactory.SelectView, parameters);
        }
        
        public static List<MyCompany.Data.Objects.BillRegister> Select(string filter, params FieldValue[] parameters)
        {
            return new BillRegisterFactory().Select(filter, null, BillRegisterFactory.SelectView, new BusinessObjectParameters(parameters));
        }
        
        public static MyCompany.Data.Objects.BillRegister SelectSingle(string filter, BusinessObjectParameters parameters)
        {
            return new BillRegisterFactory().SelectSingle(filter, parameters);
        }
        
        public static MyCompany.Data.Objects.BillRegister SelectSingle(string filter, params FieldValue[] parameters)
        {
            return new BillRegisterFactory().SelectSingle(filter, new BusinessObjectParameters(parameters));
        }
        
        public static MyCompany.Data.Objects.BillRegister SelectSingle(int? billRegisterID)
        {
            return new BillRegisterFactory().SelectSingle(billRegisterID);
        }
        
        public int Insert()
        {
            return new BillRegisterFactory().Insert(this);
        }
        
        public int Update()
        {
            return new BillRegisterFactory().Update(this);
        }
        
        public int Delete()
        {
            return new BillRegisterFactory().Delete(this);
        }
    ...
    public partial class BillRegisterFactory
    {
        
        public BillRegisterFactory()
        {
        }
        ...
        public static string SelectView
        {
            get
            {
                return Controller.GetSelectView("BillRegister");
            }
        }
        ...
        public static string InsertView
        {
            get
            {
                return Controller.GetInsertView("BillRegister");
            }
        }
        ...
        public static string UpdateView
        {
            get
            {
                return Controller.GetUpdateView("BillRegister");
            }
        }
        ...
        public static string DeleteView
        {
            get
            {
                return Controller.GetDeleteView("BillRegister");
            }
        }
        
        public static BillRegisterFactory Create()
        {
            return new BillRegisterFactory();
        }
        ...
        public List<MyCompany.Data.Objects.BillRegister> Select(
                    int? billRegisterID, 
                    string billRegisterNo, 
                    DateTime? billDate, 
                    int? supplierID, 
                    ...
                    string dataView)
        {
            ...
            ViewPage page = ControllerFactory.CreateDataController().GetPage("BillRegister", dataView, request);
            return page.ToList<MyCompany.Data.Objects.BillRegister>();
        }
        
        public List<MyCompany.Data.Objects.BillRegister> Select(MyCompany.Data.Objects.BillRegister qbe)
        {
        ...
        public MyCompany.Data.Objects.BillRegister SelectSingle(int? billRegisterID)
        {
            List<MyCompany.Data.Objects.BillRegister> list = Select(billRegisterID, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
            if (list.Count == 0)
            	return null;
            return list[0];
        }
        
        public List<MyCompany.Data.Objects.BillRegister> Select(string filter, string sort, string dataView, BusinessObjectParameters parameters)
        {
            ...
            ViewPage page = c.GetPage("BillRegister", dataView, request);
            return page.ToList<MyCompany.Data.Objects.BillRegister>();
        }
        
        public List<MyCompany.Data.Objects.BillRegister> SelectSingle(string filter, string sort, BusinessObjectParameters parameters)
        {
            return Select(filter, sort, SelectView, parameters);
        }
        
        public List<MyCompany.Data.Objects.BillRegister> Select(string filter, BusinessObjectParameters parameters)
        {
            return Select(filter, null, SelectView, parameters);
        }
        
        public MyCompany.Data.Objects.BillRegister SelectSingle(string filter, BusinessObjectParameters parameters)
        {
            List<MyCompany.Data.Objects.BillRegister> list = Select(filter, parameters);
            if (list.Count > 0)
            	return list[0];
            return null;
        }
        
        protected virtual FieldValue[] CreateFieldValues(MyCompany.Data.Objects.BillRegister theBillRegister, MyCompany.Data.Objects.BillRegister original_BillRegister)
        {
            List<FieldValue> values = new List<FieldValue>();
            values.Add(new FieldValue("BillRegisterID", original_BillRegister.BillRegisterID, theBillRegister.BillRegisterID, true));
            values.Add(new FieldValue("BillRegisterNo", original_BillRegister.BillRegisterNo, theBillRegister.BillRegisterNo));
            values.Add(new FieldValue("BillDate", original_BillRegister.BillDate, theBillRegister.BillDate));
            values.Add(new FieldValue("SupplierID", original_BillRegister.SupplierID, theBillRegister.SupplierID));
            values.Add(new FieldValue("SupplierAccSubName", original_BillRegister.SupplierAccSubName, theBillRegister.SupplierAccSubName, true));
            values.Add(new FieldValue("SupplierAccSubTypeAccSubType", original_BillRegister.SupplierAccSubTypeAccSubType, theBillRegister.SupplierAccSubTypeAccSubType, true));
            values.Add(new FieldValue("ProductDescription", original_BillRegister.ProductDescription, theBillRegister.ProductDescription));
            values.Add(new FieldValue("Reference", original_BillRegister.Reference, theBillRegister.Reference));
            values.Add(new FieldValue("Quantity", original_BillRegister.Quantity, theBillRegister.Quantity));
            values.Add(new FieldValue("UnitPrice", original_BillRegister.UnitPrice, theBillRegister.UnitPrice));
            values.Add(new FieldValue("BillAmount", original_BillRegister.BillAmount, theBillRegister.BillAmount));
            values.Add(new FieldValue("AccFundID", original_BillRegister.AccFundID, theBillRegister.AccFundID));
            values.Add(new FieldValue("AccFundAccFundName", original_BillRegister.AccFundAccFundName, theBillRegister.AccFundAccFundName, true));
            values.Add(new FieldValue("ProjectID", original_BillRegister.ProjectID, theBillRegister.ProjectID));
            values.Add(new FieldValue("PaidAmount", original_BillRegister.PaidAmount, theBillRegister.PaidAmount));
            values.Add(new FieldValue("VchrTranID", original_BillRegister.VchrTranID, theBillRegister.VchrTranID));
            values.Add(new FieldValue("VchrTypeID", original_BillRegister.VchrTypeID, theBillRegister.VchrTypeID));
            values.Add(new FieldValue("ExpenseHeadAccID", original_BillRegister.ExpenseHeadAccID, theBillRegister.ExpenseHeadAccID));
            values.Add(new FieldValue("HeadAccID", original_BillRegister.HeadAccID, theBillRegister.HeadAccID));
            values.Add(new FieldValue("HeadAccAccName", original_BillRegister.HeadAccAccName, theBillRegister.HeadAccAccName, true));
            values.Add(new FieldValue("HeadAccAccBalTypeAccBalType", original_BillRegister.HeadAccAccBalTypeAccBalType, theBillRegister.HeadAccAccBalTypeAccBalType, true));
            values.Add(new FieldValue("HeadAccAccCurrencyAccCurrencyName", original_BillRegister.HeadAccAccCurrencyAccCurrencyName, theBillRegister.HeadAccAccCurrencyAccCurrencyName, true));
            values.Add(new FieldValue("HeadAccAccDestAccDest", original_BillRegister.HeadAccAccDestAccDest, theBillRegister.HeadAccAccDestAccDest, true));
            values.Add(new FieldValue("HeadAccAccDestCompanyTypeDescription", original_BillRegister.HeadAccAccDestCompanyTypeDescription, theBillRegister.HeadAccAccDestCompanyTypeDescription, true));
            values.Add(new FieldValue("HeadAccAccFundAccFundName", original_BillRegister.HeadAccAccFundAccFundName, theBillRegister.HeadAccAccFundAccFundName, true));
            values.Add(new FieldValue("HeadAccAccSubTypeAccSubType", original_BillRegister.HeadAccAccSubTypeAccSubType, theBillRegister.HeadAccAccSubTypeAccSubType, true));
            values.Add(new FieldValue("HeadAccAccTypeAccType", original_BillRegister.HeadAccAccTypeAccType, theBillRegister.HeadAccAccTypeAccType, true));
            values.Add(new FieldValue("HeadAccCoaControlAccName", original_BillRegister.HeadAccCoaControlAccName, theBillRegister.HeadAccCoaControlAccName, true));
            values.Add(new FieldValue("HeadAccCoaControlAccBalTypeAccBalType", original_BillRegister.HeadAccCoaControlAccBalTypeAccBalType, theBillRegister.HeadAccCoaControlAccBalTypeAccBalType, true));
            values.Add(new FieldValue("HeadAccCoaControlAccDestAccDest", original_BillRegister.HeadAccCoaControlAccDestAccDest, theBillRegister.HeadAccCoaControlAccDestAccDest, true));
            values.Add(new FieldValue("HeadAccCoaControlAccTypeAccType", original_BillRegister.HeadAccCoaControlAccTypeAccType, theBillRegister.HeadAccCoaControlAccTypeAccType, true));
            values.Add(new FieldValue("HeadAccCoaControlCompTypeDescription", original_BillRegister.HeadAccCoaControlCompTypeDescription, theBillRegister.HeadAccCoaControlCompTypeDescription, true));
            values.Add(new FieldValue("HeadAccCoaMainAccName", original_BillRegister.HeadAccCoaMainAccName, theBillRegister.HeadAccCoaMainAccName, true));
            values.Add(new FieldValue("HeadAccCoaMainAccBalTypeAccBalType", original_BillRegister.HeadAccCoaMainAccBalTypeAccBalType, theBillRegister.HeadAccCoaMainAccBalTypeAccBalType, true));
            values.Add(new FieldValue("HeadAccCoaMainAccDestAccDest", original_BillRegister.HeadAccCoaMainAccDestAccDest, theBillRegister.HeadAccCoaMainAccDestAccDest, true));
            values.Add(new FieldValue("HeadAccCoaMainAccFundAccFundName", original_BillRegister.HeadAccCoaMainAccFundAccFundName, theBillRegister.HeadAccCoaMainAccFundAccFundName, true));
            values.Add(new FieldValue("HeadAccCoaMainAccTypeAccType", original_BillRegister.HeadAccCoaMainAccTypeAccType, theBillRegister.HeadAccCoaMainAccTypeAccType, true));
            values.Add(new FieldValue("HeadAccCoaMainCoaControlAccName", original_BillRegister.HeadAccCoaMainCoaControlAccName, theBillRegister.HeadAccCoaMainCoaControlAccName, true));
            values.Add(new FieldValue("HeadAccCoaSubAccName", original_BillRegister.HeadAccCoaSubAccName, theBillRegister.HeadAccCoaSubAccName, true));
            values.Add(new FieldValue("HeadAccCoaSubAccBalTypeAccBalType", original_BillRegister.HeadAccCoaSubAccBalTypeAccBalType, theBillRegister.HeadAccCoaSubAccBalTypeAccBalType, true));
            values.Add(new FieldValue("HeadAccCoaSubAccDestAccDest", original_BillRegister.HeadAccCoaSubAccDestAccDest, theBillRegister.HeadAccCoaSubAccDestAccDest, true));
            values.Add(new FieldValue("HeadAccCoaSubAccFundAccFundName", original_BillRegister.HeadAccCoaSubAccFundAccFundName, theBillRegister.HeadAccCoaSubAccFundAccFundName, true));
            values.Add(new FieldValue("HeadAccCoaSubAccTypeAccType", original_BillRegister.HeadAccCoaSubAccTypeAccType, theBillRegister.HeadAccCoaSubAccTypeAccType, true));
            values.Add(new FieldValue("HeadAccCoaSubCoaControlAccName", original_BillRegister.HeadAccCoaSubCoaControlAccName, theBillRegister.HeadAccCoaSubCoaControlAccName, true));
            values.Add(new FieldValue("HeadAccCoaSubCoaMainAccName", original_BillRegister.HeadAccCoaSubCoaMainAccName, theBillRegister.HeadAccCoaSubCoaMainAccName, true));
            values.Add(new FieldValue("RevAccID", original_BillRegister.RevAccID, theBillRegister.RevAccID));
            values.Add(new FieldValue("Bankname", original_BillRegister.Bankname, theBillRegister.Bankname));
            values.Add(new FieldValue("ChequeNo", original_BillRegister.ChequeNo, theBillRegister.ChequeNo));
            values.Add(new FieldValue("ChequeDT", original_BillRegister.ChequeDT, theBillRegister.ChequeDT));
            values.Add(new FieldValue("IsPost", original_BillRegister.IsPost, theBillRegister.IsPost));
            values.Add(new FieldValue("PostDate", original_BillRegister.PostDate, theBillRegister.PostDate));
            values.Add(new FieldValue("IsPartialPay", original_BillRegister.IsPartialPay, theBillRegister.IsPartialPay));
            return values.ToArray();
        }
        
        protected virtual int ExecuteAction(MyCompany.Data.Objects.BillRegister theBillRegister, MyCompany.Data.Objects.BillRegister original_BillRegister, string lastCommandName, string commandName, string dataView)
        {
            ActionArgs args = new ActionArgs();
            args.Controller = "BillRegister";
            args.View = dataView;
            args.Values = CreateFieldValues(theBillRegister, original_BillRegister);
            args.LastCommandName = lastCommandName;
            args.CommandName = commandName;
            ActionResult result = ControllerFactory.CreateDataController().Execute("BillRegister", dataView, args);
            result.RaiseExceptionIfErrors();
            result.AssignTo(theBillRegister);
            return result.RowsAffected;
        }
        
        [System.ComponentModel.DataObjectMethod(System.ComponentModel.DataObjectMethodType.Update)]
        public virtual int Update(MyCompany.Data.Objects.BillRegister theBillRegister, MyCompany.Data.Objects.BillRegister original_BillRegister)
        {
            return ExecuteAction(theBillRegister, original_BillRegister, "Edit", "Update", UpdateView);
        }
        
        [System.ComponentModel.DataObjectMethod(System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(MyCompany.Data.Objects.BillRegister theBillRegister)
        {
            return Update(theBillRegister, SelectSingle(theBillRegister.BillRegisterID));
        }
        
        [System.ComponentModel.DataObjectMethod(System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(MyCompany.Data.Objects.BillRegister theBillRegister)
        {
            return ExecuteAction(theBillRegister, new BillRegister(), "New", "Insert", InsertView);
        }
        
        [System.ComponentModel.DataObjectMethod(System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(MyCompany.Data.Objects.BillRegister theBillRegister)
        {
            return ExecuteAction(theBillRegister, theBillRegister, "Select", "Delete", DeleteView);
        }
    }
}

...
namespace MyCompany.Data.Objects
{
    ...
    public partial class BillRegisterPayment
    {
        ...
        public static List<MyCompany.Data.Objects.BillRegisterPayment> Select(
                    int? billRegisterID, 
                    ...
                    string isPartialPay)
        {
            return new BillRegisterPaymentFactory().Select(billRegisterID, billRegisterNo, billDate, supplierID, supplierAccSubName, supplierAccSubTypeAccSubType, productDescription, reference, quantity, unitPrice, billAmount, accFundID, accFundAccFundName, projectID, paidAmount, vchrTranID, vchrTypeID, expenseHeadAccID, headAccID, headAccAccName, headAccAccBalTypeAccBalType, headAccAccCurrencyAccCurrencyName, headAccAccDestAccDest, headAccAccDestCompanyTypeDescription, headAccAccFundAccFundName, headAccAccSubTypeAccSubType, headAccAccTypeAccType, headAccCoaControlAccName, headAccCoaControlAccBalTypeAccBalType, headAccCoaControlAccDestAccDest, headAccCoaControlAccTypeAccType, headAccCoaControlCompTypeDescription, headAccCoaMainAccName, headAccCoaMainAccBalTypeAccBalType, headAccCoaMainAccDestAccDest, headAccCoaMainAccFundAccFundName, headAccCoaMainAccTypeAccType, headAccCoaMainCoaControlAccName, headAccCoaSubAccName, headAccCoaSubAccBalTypeAccBalType, headAccCoaSubAccDestAccDest, headAccCoaSubAccFundAccFundName, headAccCoaSubAccTypeAccType, headAccCoaSubCoaControlAccName, headAccCoaSubCoaMainAccName, revAccID, bankname, chequeNo, chequeDT, isPost, postDate, isPartialPay);
        }
        
        public static List<MyCompany.Data.Objects.BillRegisterPayment> Select(MyCompany.Data.Objects.BillRegisterPayment qbe)
        {
            return new BillRegisterPaymentFactory().Select(qbe);
        }
        
        public static List<MyCompany.Data.Objects.BillRegisterPayment> Select(string filter, string sort, string dataView, BusinessObjectParameters parameters)
        {
            return new BillRegisterPaymentFactory().Select(filter, sort, dataView, parameters);
        }
        
        public static List<MyCompany.Data.Objects.BillRegisterPayment> Select(string filter, string sort, string dataView, params FieldValue[] parameters)
        {
            return new BillRegisterPaymentFactory().Select(filter, sort, dataView, new BusinessObjectParameters(parameters));
        }
        
        public static List<MyCompany.Data.Objects.BillRegisterPayment> Select(string filter, string sort, BusinessObjectParameters parameters)
        {
            return new BillRegisterPaymentFactory().Select(filter, sort, BillRegisterPaymentFactory.SelectView, parameters);
        }
        
        public static List<MyCompany.Data.Objects.BillRegisterPayment> Select(string filter, string sort, params FieldValue[] parameters)
        {
            return new BillRegisterPaymentFactory().Select(filter, sort, BillRegisterPaymentFactory.SelectView, new BusinessObjectParameters(parameters));
        }
        
        public static List<MyCompany.Data.Objects.BillRegisterPayment> Select(string filter, BusinessObjectParameters parameters)
        {
            return new BillRegisterPaymentFactory().Select(filter, null, BillRegisterPaymentFactory.SelectView, parameters);
        }
        
        public static List<MyCompany.Data.Objects.BillRegisterPayment> Select(string filter, params FieldValue[] parameters)
        {
            return new BillRegisterPaymentFactory().Select(filter, null, BillRegisterPaymentFactory.SelectView, new BusinessObjectParameters(parameters));
        }
        
        public static MyCompany.Data.Objects.BillRegisterPayment SelectSingle(string filter, BusinessObjectParameters parameters)
        {
            return new BillRegisterPaymentFactory().SelectSingle(filter, parameters);
        }
        
        public static MyCompany.Data.Objects.BillRegisterPayment SelectSingle(string filter, params FieldValue[] parameters)
        {
            return new BillRegisterPaymentFactory().SelectSingle(filter, new BusinessObjectParameters(parameters));
        }
        
        public static MyCompany.Data.Objects.BillRegisterPayment SelectSingle(int? billRegisterID)
        {
            return new BillRegisterPaymentFactory().SelectSingle(billRegisterID);
        }
        
        public int Insert()
        {
            return new BillRegisterPaymentFactory().Insert(this);
        }
        
        public int Update()
        {
            return new BillRegisterPaymentFactory().Update(this);
        }
        
        public int Delete()
        {
            return new BillRegisterPaymentFactory().Delete(this);
        }
    ...
    public partial class BillRegisterPaymentFactory
    {
        
        public BillRegisterPaymentFactory()
        {
        }
        ...
        public static string SelectView
        {
            get
            {
                return Controller.GetSelectView("BillRegisterPayment");
            }
        }
        ...
        public static string InsertView
        {
            get
            {
                return Controller.GetInsertView("BillRegisterPayment");
            }
        }
        ...
        public static string UpdateView
        {
            get
            {
                return Controller.GetUpdateView("BillRegisterPayment");
            }
        }
        ...
        public static string DeleteView
        {
            get
            {
                return Controller.GetDeleteView("BillRegisterPayment");
            }
        }
        
        public static BillRegisterPaymentFactory Create()
        {
            return new BillRegisterPaymentFactory();
        }
        ...
        public List<MyCompany.Data.Objects.BillRegisterPayment> Select(
                    int? billRegisterID, 
                    string billRegisterNo, 
                    DateTime? billDate, 
                    int? supplierID, 
                    ...
                    string dataView)
        {
            ...
            ViewPage page = ControllerFactory.CreateDataController().GetPage("BillRegisterPayment", dataView, request);
            return page.ToList<MyCompany.Data.Objects.BillRegisterPayment>();
        }
        
        public List<MyCompany.Data.Objects.BillRegisterPayment> Select(MyCompany.Data.Objects.BillRegisterPayment qbe)
        {
        ...
        public MyCompany.Data.Objects.BillRegisterPayment SelectSingle(int? billRegisterID)
        {
            List<MyCompany.Data.Objects.BillRegisterPayment> list = Select(billRegisterID, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
            if (list.Count == 0)
            	return null;
            return list[0];
        }
        
        public List<MyCompany.Data.Objects.BillRegisterPayment> Select(string filter, string sort, string dataView, BusinessObjectParameters parameters)
        {
            ...
            ViewPage page = c.GetPage("BillRegisterPayment", dataView, request);
            return page.ToList<MyCompany.Data.Objects.BillRegisterPayment>();
        }
        
        public List<MyCompany.Data.Objects.BillRegisterPayment> SelectSingle(string filter, string sort, BusinessObjectParameters parameters)
        {
            return Select(filter, sort, SelectView, parameters);
        }
        
        public List<MyCompany.Data.Objects.BillRegisterPayment> Select(string filter, BusinessObjectParameters parameters)
        {
            return Select(filter, null, SelectView, parameters);
        }
        
        public MyCompany.Data.Objects.BillRegisterPayment SelectSingle(string filter, BusinessObjectParameters parameters)
        {
            List<MyCompany.Data.Objects.BillRegisterPayment> list = Select(filter, parameters);
            if (list.Count > 0)
            	return list[0];
            return null;
        }
        
        protected virtual FieldValue[] CreateFieldValues(MyCompany.Data.Objects.BillRegisterPayment theBillRegisterPayment, MyCompany.Data.Objects.BillRegisterPayment original_BillRegisterPayment)
        {
            List<FieldValue> values = new List<FieldValue>();
            values.Add(new FieldValue("BillRegisterID", original_BillRegisterPayment.BillRegisterID, theBillRegisterPayment.BillRegisterID, true));
            values.Add(new FieldValue("BillRegisterNo", original_BillRegisterPayment.BillRegisterNo, theBillRegisterPayment.BillRegisterNo));
            values.Add(new FieldValue("BillDate", original_BillRegisterPayment.BillDate, theBillRegisterPayment.BillDate));
            values.Add(new FieldValue("SupplierID", original_BillRegisterPayment.SupplierID, theBillRegisterPayment.SupplierID));
            values.Add(new FieldValue("SupplierAccSubName", original_BillRegisterPayment.SupplierAccSubName, theBillRegisterPayment.SupplierAccSubName, true));
            values.Add(new FieldValue("SupplierAccSubTypeAccSubType", original_BillRegisterPayment.SupplierAccSubTypeAccSubType, theBillRegisterPayment.SupplierAccSubTypeAccSubType, true));
            values.Add(new FieldValue("ProductDescription", original_BillRegisterPayment.ProductDescription, theBillRegisterPayment.ProductDescription));
            values.Add(new FieldValue("Reference", original_BillRegisterPayment.Reference, theBillRegisterPayment.Reference));
            values.Add(new FieldValue("Quantity", original_BillRegisterPayment.Quantity, theBillRegisterPayment.Quantity));
            values.Add(new FieldValue("UnitPrice", original_BillRegisterPayment.UnitPrice, theBillRegisterPayment.UnitPrice));
            values.Add(new FieldValue("BillAmount", original_BillRegisterPayment.BillAmount, theBillRegisterPayment.BillAmount));
            values.Add(new FieldValue("AccFundID", original_BillRegisterPayment.AccFundID, theBillRegisterPayment.AccFundID));
            values.Add(new FieldValue("AccFundAccFundName", original_BillRegisterPayment.AccFundAccFundName, theBillRegisterPayment.AccFundAccFundName, true));
            values.Add(new FieldValue("ProjectID", original_BillRegisterPayment.ProjectID, theBillRegisterPayment.ProjectID));
            values.Add(new FieldValue("PaidAmount", original_BillRegisterPayment.PaidAmount, theBillRegisterPayment.PaidAmount));
            values.Add(new FieldValue("VchrTranID", original_BillRegisterPayment.VchrTranID, theBillRegisterPayment.VchrTranID));
            values.Add(new FieldValue("VchrTypeID", original_BillRegisterPayment.VchrTypeID, theBillRegisterPayment.VchrTypeID));
            values.Add(new FieldValue("ExpenseHeadAccID", original_BillRegisterPayment.ExpenseHeadAccID, theBillRegisterPayment.ExpenseHeadAccID));
            values.Add(new FieldValue("HeadAccID", original_BillRegisterPayment.HeadAccID, theBillRegisterPayment.HeadAccID));
            values.Add(new FieldValue("HeadAccAccName", original_BillRegisterPayment.HeadAccAccName, theBillRegisterPayment.HeadAccAccName, true));
            values.Add(new FieldValue("HeadAccAccBalTypeAccBalType", original_BillRegisterPayment.HeadAccAccBalTypeAccBalType, theBillRegisterPayment.HeadAccAccBalTypeAccBalType, true));
            values.Add(new FieldValue("HeadAccAccCurrencyAccCurrencyName", original_BillRegisterPayment.HeadAccAccCurrencyAccCurrencyName, theBillRegisterPayment.HeadAccAccCurrencyAccCurrencyName, true));
            values.Add(new FieldValue("HeadAccAccDestAccDest", original_BillRegisterPayment.HeadAccAccDestAccDest, theBillRegisterPayment.HeadAccAccDestAccDest, true));
            values.Add(new FieldValue("HeadAccAccDestCompanyTypeDescription", original_BillRegisterPayment.HeadAccAccDestCompanyTypeDescription, theBillRegisterPayment.HeadAccAccDestCompanyTypeDescription, true));
            values.Add(new FieldValue("HeadAccAccFundAccFundName", original_BillRegisterPayment.HeadAccAccFundAccFundName, theBillRegisterPayment.HeadAccAccFundAccFundName, true));
            values.Add(new FieldValue("HeadAccAccSubTypeAccSubType", original_BillRegisterPayment.HeadAccAccSubTypeAccSubType, theBillRegisterPayment.HeadAccAccSubTypeAccSubType, true));
            values.Add(new FieldValue("HeadAccAccTypeAccType", original_BillRegisterPayment.HeadAccAccTypeAccType, theBillRegisterPayment.HeadAccAccTypeAccType, true));
            values.Add(new FieldValue("HeadAccCoaControlAccName", original_BillRegisterPayment.HeadAccCoaControlAccName, theBillRegisterPayment.HeadAccCoaControlAccName, true));
            values.Add(new FieldValue("HeadAccCoaControlAccBalTypeAccBalType", original_BillRegisterPayment.HeadAccCoaControlAccBalTypeAccBalType, theBillRegisterPayment.HeadAccCoaControlAccBalTypeAccBalType, true));
            values.Add(new FieldValue("HeadAccCoaControlAccDestAccDest", original_BillRegisterPayment.HeadAccCoaControlAccDestAccDest, theBillRegisterPayment.HeadAccCoaControlAccDestAccDest, true));
            values.Add(new FieldValue("HeadAccCoaControlAccTypeAccType", original_BillRegisterPayment.HeadAccCoaControlAccTypeAccType, theBillRegisterPayment.HeadAccCoaControlAccTypeAccType, true));
            values.Add(new FieldValue("HeadAccCoaControlCompTypeDescription", original_BillRegisterPayment.HeadAccCoaControlCompTypeDescription, theBillRegisterPayment.HeadAccCoaControlCompTypeDescription, true));
            values.Add(new FieldValue("HeadAccCoaMainAccName", original_BillRegisterPayment.HeadAccCoaMainAccName, theBillRegisterPayment.HeadAccCoaMainAccName, true));
            values.Add(new FieldValue("HeadAccCoaMainAccBalTypeAccBalType", original_BillRegisterPayment.HeadAccCoaMainAccBalTypeAccBalType, theBillRegisterPayment.HeadAccCoaMainAccBalTypeAccBalType, true));
            values.Add(new FieldValue("HeadAccCoaMainAccDestAccDest", original_BillRegisterPayment.HeadAccCoaMainAccDestAccDest, theBillRegisterPayment.HeadAccCoaMainAccDestAccDest, true));
            values.Add(new FieldValue("HeadAccCoaMainAccFundAccFundName", original_BillRegisterPayment.HeadAccCoaMainAccFundAccFundName, theBillRegisterPayment.HeadAccCoaMainAccFundAccFundName, true));
            values.Add(new FieldValue("HeadAccCoaMainAccTypeAccType", original_BillRegisterPayment.HeadAccCoaMainAccTypeAccType, theBillRegisterPayment.HeadAccCoaMainAccTypeAccType, true));
            values.Add(new FieldValue("HeadAccCoaMainCoaControlAccName", original_BillRegisterPayment.HeadAccCoaMainCoaControlAccName, theBillRegisterPayment.HeadAccCoaMainCoaControlAccName, true));
            values.Add(new FieldValue("HeadAccCoaSubAccName", original_BillRegisterPayment.HeadAccCoaSubAccName, theBillRegisterPayment.HeadAccCoaSubAccName, true));
            values.Add(new FieldValue("HeadAccCoaSubAccBalTypeAccBalType", original_BillRegisterPayment.HeadAccCoaSubAccBalTypeAccBalType, theBillRegisterPayment.HeadAccCoaSubAccBalTypeAccBalType, true));
            values.Add(new FieldValue("HeadAccCoaSubAccDestAccDest", original_BillRegisterPayment.HeadAccCoaSubAccDestAccDest, theBillRegisterPayment.HeadAccCoaSubAccDestAccDest, true));
            values.Add(new FieldValue("HeadAccCoaSubAccFundAccFundName", original_BillRegisterPayment.HeadAccCoaSubAccFundAccFundName, theBillRegisterPayment.HeadAccCoaSubAccFundAccFundName, true));
            values.Add(new FieldValue("HeadAccCoaSubAccTypeAccType", original_BillRegisterPayment.HeadAccCoaSubAccTypeAccType, theBillRegisterPayment.HeadAccCoaSubAccTypeAccType, true));
            values.Add(new FieldValue("HeadAccCoaSubCoaControlAccName", original_BillRegisterPayment.HeadAccCoaSubCoaControlAccName, theBillRegisterPayment.HeadAccCoaSubCoaControlAccName, true));
            values.Add(new FieldValue("HeadAccCoaSubCoaMainAccName", original_BillRegisterPayment.HeadAccCoaSubCoaMainAccName, theBillRegisterPayment.HeadAccCoaSubCoaMainAccName, true));
            values.Add(new FieldValue("RevAccID", original_BillRegisterPayment.RevAccID, theBillRegisterPayment.RevAccID));
            values.Add(new FieldValue("Bankname", original_BillRegisterPayment.Bankname, theBillRegisterPayment.Bankname));
            values.Add(new FieldValue("ChequeNo", original_BillRegisterPayment.ChequeNo, theBillRegisterPayment.ChequeNo));
            values.Add(new FieldValue("ChequeDT", original_BillRegisterPayment.ChequeDT, theBillRegisterPayment.ChequeDT));
            values.Add(new FieldValue("IsPost", original_BillRegisterPayment.IsPost, theBillRegisterPayment.IsPost));
            values.Add(new FieldValue("PostDate", original_BillRegisterPayment.PostDate, theBillRegisterPayment.PostDate));
            values.Add(new FieldValue("IsPartialPay", original_BillRegisterPayment.IsPartialPay, theBillRegisterPayment.IsPartialPay));
            return values.ToArray();
        }
        
        protected virtual int ExecuteAction(MyCompany.Data.Objects.BillRegisterPayment theBillRegisterPayment, MyCompany.Data.Objects.BillRegisterPayment original_BillRegisterPayment, string lastCommandName, string commandName, string dataView)
        {
            ActionArgs args = new ActionArgs();
            args.Controller = "BillRegisterPayment";
            args.View = dataView;
            args.Values = CreateFieldValues(theBillRegisterPayment, original_BillRegisterPayment);
            args.LastCommandName = lastCommandName;
            args.CommandName = commandName;
            ActionResult result = ControllerFactory.CreateDataController().Execute("BillRegisterPayment", dataView, args);
            result.RaiseExceptionIfErrors();
            result.AssignTo(theBillRegisterPayment);
            return result.RowsAffected;
        }
        
        [System.ComponentModel.DataObjectMethod(System.ComponentModel.DataObjectMethodType.Update)]
        public virtual int Update(MyCompany.Data.Objects.BillRegisterPayment theBillRegisterPayment, MyCompany.Data.Objects.BillRegisterPayment original_BillRegisterPayment)
        {
            return ExecuteAction(theBillRegisterPayment, original_BillRegisterPayment, "Edit", "Update", UpdateView);
        }
        
        [System.ComponentModel.DataObjectMethod(System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(MyCompany.Data.Objects.BillRegisterPayment theBillRegisterPayment)
        {
            return Update(theBillRegisterPayment, SelectSingle(theBillRegisterPayment.BillRegisterID));
        }
        
        [System.ComponentModel.DataObjectMethod(System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(MyCompany.Data.Objects.BillRegisterPayment theBillRegisterPayment)
        {
            return ExecuteAction(theBillRegisterPayment, new BillRegisterPayment(), "New", "Insert", InsertView);
        }
        
        [System.ComponentModel.DataObjectMethod(System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(MyCompany.Data.Objects.BillRegisterPayment theBillRegisterPayment)
        {
            return ExecuteAction(theBillRegisterPayment, theBillRegisterPayment, "Select", "Delete", DeleteView);
        }
    }
}

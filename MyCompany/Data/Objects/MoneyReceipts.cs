...
namespace MyCompany.Data.Objects
{
    ...
    public partial class MoneyReceipts
    {
        ...
        public static List<MyCompany.Data.Objects.MoneyReceipts> Select(
        ...
        public static List<MyCompany.Data.Objects.MoneyReceipts> Select(string filter, string sort, string dataView, BusinessObjectParameters parameters)
        {
            return new MoneyReceiptsFactory().Select(filter, sort, dataView, parameters);
        }
        
        public static List<MyCompany.Data.Objects.MoneyReceipts> Select(string filter, string sort, string dataView, params FieldValue[] parameters)
        {
            return new MoneyReceiptsFactory().Select(filter, sort, dataView, new BusinessObjectParameters(parameters));
        }
        
        public static List<MyCompany.Data.Objects.MoneyReceipts> Select(string filter, string sort, BusinessObjectParameters parameters)
        {
            return new MoneyReceiptsFactory().Select(filter, sort, MoneyReceiptsFactory.SelectView, parameters);
        }
        
        public static List<MyCompany.Data.Objects.MoneyReceipts> Select(string filter, string sort, params FieldValue[] parameters)
        {
            return new MoneyReceiptsFactory().Select(filter, sort, MoneyReceiptsFactory.SelectView, new BusinessObjectParameters(parameters));
        }
        
        public static List<MyCompany.Data.Objects.MoneyReceipts> Select(string filter, BusinessObjectParameters parameters)
        {
            return new MoneyReceiptsFactory().Select(filter, null, MoneyReceiptsFactory.SelectView, parameters);
        }
        
        public static List<MyCompany.Data.Objects.MoneyReceipts> Select(string filter, params FieldValue[] parameters)
        {
            return new MoneyReceiptsFactory().Select(filter, null, MoneyReceiptsFactory.SelectView, new BusinessObjectParameters(parameters));
        }
        
        public static MyCompany.Data.Objects.MoneyReceipts SelectSingle(string filter, BusinessObjectParameters parameters)
        {
            return new MoneyReceiptsFactory().SelectSingle(filter, parameters);
        }
        
        public static MyCompany.Data.Objects.MoneyReceipts SelectSingle(string filter, params FieldValue[] parameters)
        {
            return new MoneyReceiptsFactory().SelectSingle(filter, new BusinessObjectParameters(parameters));
        }
        
        public static MyCompany.Data.Objects.MoneyReceipts SelectSingle(long? moneyReceiptsID)
        {
            return new MoneyReceiptsFactory().SelectSingle(moneyReceiptsID);
        }
        
        public int Insert()
        {
            return new MoneyReceiptsFactory().Insert(this);
        }
        
        public int Update()
        {
            return new MoneyReceiptsFactory().Update(this);
        }
        
        public int Delete()
        {
            return new MoneyReceiptsFactory().Delete(this);
        }
    ...
    public partial class MoneyReceiptsFactory
    {
        
        public MoneyReceiptsFactory()
        {
        }
        ...
        public static string SelectView
        {
            get
            {
                return Controller.GetSelectView("MoneyReceipts");
            }
        }
        ...
        public static string InsertView
        {
            get
            {
                return Controller.GetInsertView("MoneyReceipts");
            }
        }
        ...
        public static string UpdateView
        {
            get
            {
                return Controller.GetUpdateView("MoneyReceipts");
            }
        }
        ...
        public static string DeleteView
        {
            get
            {
                return Controller.GetDeleteView("MoneyReceipts");
            }
        }
        
        public static MoneyReceiptsFactory Create()
        {
            return new MoneyReceiptsFactory();
        }
        ...
        public List<MyCompany.Data.Objects.MoneyReceipts> Select(
                    long? moneyReceiptsID, 
                    DateTime? mRDate, 
                    string mRNo, 
                    long? plotSaleID, 
                    ...
                    string dataView)
        {
            ...
            ViewPage page = ControllerFactory.CreateDataController().GetPage("MoneyReceipts", dataView, request);
            return page.ToList<MyCompany.Data.Objects.MoneyReceipts>();
        }
        ...
        public MyCompany.Data.Objects.MoneyReceipts SelectSingle(long? moneyReceiptsID)
        {
            List<MyCompany.Data.Objects.MoneyReceipts> list = Select(moneyReceiptsID, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
            if (list.Count == 0)
            	return null;
            return list[0];
        }
        
        public List<MyCompany.Data.Objects.MoneyReceipts> Select(string filter, string sort, string dataView, BusinessObjectParameters parameters)
        {
            ...
            ViewPage page = c.GetPage("MoneyReceipts", dataView, request);
            return page.ToList<MyCompany.Data.Objects.MoneyReceipts>();
        }
        
        public List<MyCompany.Data.Objects.MoneyReceipts> SelectSingle(string filter, string sort, BusinessObjectParameters parameters)
        {
            return Select(filter, sort, SelectView, parameters);
        }
        
        public List<MyCompany.Data.Objects.MoneyReceipts> Select(string filter, BusinessObjectParameters parameters)
        {
            return Select(filter, null, SelectView, parameters);
        }
        
        public MyCompany.Data.Objects.MoneyReceipts SelectSingle(string filter, BusinessObjectParameters parameters)
        {
            List<MyCompany.Data.Objects.MoneyReceipts> list = Select(filter, parameters);
            if (list.Count > 0)
            	return list[0];
            return null;
        }
        ...
        protected virtual int ExecuteAction(MyCompany.Data.Objects.MoneyReceipts theMoneyReceipts, MyCompany.Data.Objects.MoneyReceipts original_MoneyReceipts, string lastCommandName, string commandName, string dataView)
        {
            ActionArgs args = new ActionArgs();
            args.Controller = "MoneyReceipts";
            args.View = dataView;
            args.Values = CreateFieldValues(theMoneyReceipts, original_MoneyReceipts);
            args.LastCommandName = lastCommandName;
            args.CommandName = commandName;
            ActionResult result = ControllerFactory.CreateDataController().Execute("MoneyReceipts", dataView, args);
            result.RaiseExceptionIfErrors();
            result.AssignTo(theMoneyReceipts);

...
namespace MyCompany.Data.Objects
{
    ...
    public partial class GeneralLedgers
    {
        ...
        public static List<MyCompany.Data.Objects.GeneralLedgers> Select(
                    string status, 
                    string accCode, 
                    string accName, 
                    decimal? openbal, 
        ...
        {
            return new GeneralLedgersFactory().Select(status, accCode, accName, openbal, tranDate, vchr_no, trnSL_no, refno, v_Type, remarks, debit, trnDebit, drcur, credit, trnCredit, crCur, accFundCode, accCompany, ledCode, ledgerName, balType, ledCurrency, accNature, fundName, accSubTypeID, accSubCode, subName, voucher, tran_Comment, trStat, paidTo, mainName, ledAccCodeName);
        }
        
        public static List<MyCompany.Data.Objects.GeneralLedgers> Select(MyCompany.Data.Objects.GeneralLedgers qbe)
        {
            return new GeneralLedgersFactory().Select(qbe);
        }
        
        public static List<MyCompany.Data.Objects.GeneralLedgers> Select(string filter, string sort, string dataView, BusinessObjectParameters parameters)
        {
            return new GeneralLedgersFactory().Select(filter, sort, dataView, parameters);
        }
        
        public static List<MyCompany.Data.Objects.GeneralLedgers> Select(string filter, string sort, string dataView, params FieldValue[] parameters)
        {
            return new GeneralLedgersFactory().Select(filter, sort, dataView, new BusinessObjectParameters(parameters));
        }
        
        public static List<MyCompany.Data.Objects.GeneralLedgers> Select(string filter, string sort, BusinessObjectParameters parameters)
        {
            return new GeneralLedgersFactory().Select(filter, sort, GeneralLedgersFactory.SelectView, parameters);
        }
        
        public static List<MyCompany.Data.Objects.GeneralLedgers> Select(string filter, string sort, params FieldValue[] parameters)
        {
            return new GeneralLedgersFactory().Select(filter, sort, GeneralLedgersFactory.SelectView, new BusinessObjectParameters(parameters));
        }
        
        public static List<MyCompany.Data.Objects.GeneralLedgers> Select(string filter, BusinessObjectParameters parameters)
        {
            return new GeneralLedgersFactory().Select(filter, null, GeneralLedgersFactory.SelectView, parameters);
        }
        
        public static List<MyCompany.Data.Objects.GeneralLedgers> Select(string filter, params FieldValue[] parameters)
        {
            return new GeneralLedgersFactory().Select(filter, null, GeneralLedgersFactory.SelectView, new BusinessObjectParameters(parameters));
        }
        
        public static MyCompany.Data.Objects.GeneralLedgers SelectSingle(string filter, BusinessObjectParameters parameters)
        {
            return new GeneralLedgersFactory().SelectSingle(filter, parameters);
        }
        
        public static MyCompany.Data.Objects.GeneralLedgers SelectSingle(string filter, params FieldValue[] parameters)
        {
            return new GeneralLedgersFactory().SelectSingle(filter, new BusinessObjectParameters(parameters));
        }
    ...
    public partial class GeneralLedgersFactory
    {
        
        public GeneralLedgersFactory()
        {
        }
        ...
        public static string SelectView
        {
            get
            {
                return Controller.GetSelectView("GeneralLedgers");
            }
        }
        ...
        public static string InsertView
        {
            get
            {
                return Controller.GetInsertView("GeneralLedgers");
            }
        }
        ...
        public static string UpdateView
        {
            get
            {
                return Controller.GetUpdateView("GeneralLedgers");
            }
        }
        ...
        public static string DeleteView
        {
            get
            {
                return Controller.GetDeleteView("GeneralLedgers");
            }
        }
        
        public static GeneralLedgersFactory Create()
        {
            return new GeneralLedgersFactory();
        }
        ...
        public List<MyCompany.Data.Objects.GeneralLedgers> Select(
                    string status, 
                    string accCode, 
                    string accName, 
                    decimal? openbal, 
                    ...
                    string dataView)
        {
            ...
            ViewPage page = ControllerFactory.CreateDataController().GetPage("GeneralLedgers", dataView, request);
            return page.ToList<MyCompany.Data.Objects.GeneralLedgers>();
        }
        
        public List<MyCompany.Data.Objects.GeneralLedgers> Select(MyCompany.Data.Objects.GeneralLedgers qbe)
        {
        ...
        public List<MyCompany.Data.Objects.GeneralLedgers> Select(string filter, string sort, string dataView, BusinessObjectParameters parameters)
        {
            ...
            ViewPage page = c.GetPage("GeneralLedgers", dataView, request);
            return page.ToList<MyCompany.Data.Objects.GeneralLedgers>();
        }
        
        public List<MyCompany.Data.Objects.GeneralLedgers> SelectSingle(string filter, string sort, BusinessObjectParameters parameters)
        {
            return Select(filter, sort, SelectView, parameters);
        }
        
        public List<MyCompany.Data.Objects.GeneralLedgers> Select(string filter, BusinessObjectParameters parameters)
        {
            return Select(filter, null, SelectView, parameters);
        }
        
        public MyCompany.Data.Objects.GeneralLedgers SelectSingle(string filter, BusinessObjectParameters parameters)
        {
            List<MyCompany.Data.Objects.GeneralLedgers> list = Select(filter, parameters);
            if (list.Count > 0)
            	return list[0];
            return null;
        }

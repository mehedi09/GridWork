...
namespace MyCompany.Data
{
	public partial class DataControllerBase
    {
        ...
        public static string CreateReportInstance(Type t, string name, string controller, string view, bool validate)
        {
            ...
            Stream res = t.Assembly.GetManifestResourceStream(String.Format("MyCompany.Reports.{0}", name));
            if (res == null)
            	res = t.Assembly.GetManifestResourceStream(String.Format("MyCompany.{0}", name));
            if (res == null)
            {

...
namespace MyCompany.Handlers
{
	public partial class BlobFactory
    {
        ...
        static BlobFactory()
        {
            ...
            RegisterHandler("AccFundsCompanyLOGO", "\"dbo\".\"AccFunds\"", "\"CompanyLOGO\"", new string[] {
                        "\"AccFundID\""}, "Acc Funds Company LOGO", "AccFunds", "CompanyLOGO");
            RegisterHandler("CompanyLogo", "\"dbo\".\"Company\"", "\"Logo\"", new string[] {
                        "\"CompanyID\""}, "Company Logo", "Company", "Logo");
            RegisterHandler("EmployeesPhoto", "\"dbo\".\"Employees\"", "\"Photo\"", new string[] {
                        "\"EmployeeID\""}, "Employees Photo", "Employees", "Photo");
            RegisterHandler("EmployeesDegitalSign", "\"dbo\".\"Employees\"", "\"DegitalSign\"", new string[] {
                        "\"EmployeeID\""}, "Employees Degital Sign", "Employees", "DegitalSign");
        }
    }
            ...
            if (handler.Mode == BlobMode.Upload)
            	...
            	if (Blob.DirectAccessMode)
                {
                    ...
                    else
                    {
                        ...
                        if ((!(ba.IsPublic) && !(context.User.Identity.IsAuthenticated)) && !(BlobAdapter.ValidationKey.Equals(key)))
                        {
...
function UploadSuccess(key, message) { 
    ...
    public class BlobAdapter
    {
        ...
        public static string ValidationKey
        {
            get
            {
                return "93E9A93A23D20E15894D6AF003F0976C8778D9371B26ED2A2D392E84EC93A53F1CFAA7EC06BC01EAE" +

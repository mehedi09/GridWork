<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BankReceipt.ascx.cs" Inherits="Controls_BankRecipt" %>
        ...
        <div id="FromNSearch" runat="server">
            <div id="Find_Voucher_Form" runat="server">
                ...
                <div class="ParaHeader" align="center">
                    ...
                    <asp:Button ID="Button2" runat="server" Text="Return" CssClass="btn" OnClick="Cancel_Voucher"
                     Height="23px" Width="87px" />
                </div>
            </div>
                                ...
                                <table>
                                    ...
                                    <tr id="tr_for_CashPayment1" runat="server">
                                        ...
                                        <td>
                                            ...
                                            <asp:TextBox ID="txt_CheckNo" runat="server" Style="width: 210px" Visible="false">

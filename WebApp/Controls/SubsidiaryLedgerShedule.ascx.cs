...
public partial class Controls_SubsidiaryLedgerShedule : System.Web.UI.UserControl
{
    ...
    private void showReport()
    {
        ...
        try
        {
            ...
            fileName = "UspSubsidiaryLedgerSchuldule" + DateTime.Now.ToFileTime() + ".pdf";
    ...
    protected void return_BalancheRptForm_Click(object sender, EventArgs e)
    {
        ...
        rptHeader.Visible = false;
        clear();
        Response.Redirect("~/Pages/SupplierLedgerShedule.aspx");

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BankPayment.ascx.cs" Inherits="Controls_BankPayment" %>
        ...
        <div id="FromNSearch" runat="server">
            <div id="Find_Voucher_Form" runat="server">
                ...
                <div class="ParaHeader" align="center">
                    ...
                    <asp:Button ID="Button2" runat="server" Text="New" CssClass="btn" OnClick="Cancel_Voucher"
                        Height="23px" Width="87px" />
            ...
            <div id="VC_Form" runat="server">
                            ...
                            <td valign="top">
                                <table>
                                    ...
                                    <tr runat="server" id="tr_Cash_Bank">
                                        <td class="Header" valign="top">Bank Account :
                                        </td>
                                        <td>
                ...
                <div class="ParaHeader" align="center">
                 ...
                 <asp:Button ID="btn_New" runat="server" Text="New" CssClass="btn" OnClick="Cancel_Voucher"
                        Height="23px" Width="87px" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   <%-- <asp:Button ID="Button3" runat="server" Text="Cancel Voucher" Visible="false" CssClass="btn" OnClick="Delete_Voucher"
                        Height="23px" Width="87px" />--%>

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChequeIssue.ascx.cs" Inherits="Controls_ChequeIssue"  %>
                ...
                <div>
                    <table style="width: 100%">
                            ...
                            <td valign="top">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style1" runat="server" id="tr_Cash_Bank">Bank Account :</td>
                                        <td runat="server" id="tr_Cash_Bank1">
                                            <div class="FieldPlaceholder DataOnly">
                                    ...
                                    <tr runat="server" visible="false">
                                        <td class="Header" valign="top">Fund Source:
                                        </td>
                                        <td class="auto-style1">
                                            <div class="FieldPlaceholder DataOnly">
                                                <asp:DropDownList ID="DDLFund_Source" runat="server" Style="width: 210px">
                                                </asp:DropDownList>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                           ...
                                           <asp:TextBox ID="txt_CheckNo" runat="server" Style="width: 210px" Visible="false" Enabled="false"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txt_Voucher_Narration" runat="server" Style="width: 210px" TextMode="MultiLine" Height="70px"></asp:TextBox>
                            </td>
                            <td colspan="3"></td>
                        ...
                        <tr>
                            ...
                            <td valign="top">
                                <table style="float: right">
                                    <tr>
                                        <td style="text-shadow: inherit"></td>
                                        ...
                                        <td>
                                            <div class="FieldPlaceholder DataOnly"
                                                ...
                                                <asp:Label ID="lblDate" runat="server"><%--<%= System.DateTime.Now %>--%></asp:Label>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <asp:GridView ID="Gridview1" runat="server" ShowFooter="true" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="">
                                <ItemTemplate>
                                    <div align="center">
                                        <asp:Button ID="ButtonDlt" Text="Delete" CommandName="Delete" CausesValidation="False" runat="server" Style="width: 60%"
            ...
            $(document).ready(function () {
                ...
                $("#ctl00_PageContentPlaceHolder_control1_txt_Paid_To").autocomplete({
                    source: function (request, response) {
                        //alert(request.term);
                        $.ajax({
                            url: "/Pages/ChequeIssue.aspx/GetPaidToName",

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChequeReceiptRegister.ascx.cs" Inherits="Controls_ChequeReceiptRegister" %>
    ...
    <ContentTemplate>
          ...
          <div style="margin: 2px; padding: 8px;">
            ...
            <div style="float: left; position: relative; padding-left: 10px;">
                ...
                <div style="clear: both; height: 10px;"></div>
                <div style="float: left; position: relative; width: 125px;" class="auto-style1"><strong>Bank Name </strong></div>
                <div style="float: left; position: relative; padding-left: 10px;">
                    <asp:DropDownList ID="ddlBankName" runat="server" Width="200px" AutoPostBack="True">
                    </asp:DropDownList>

                </div>

                <div style="clear: both; height: 10px;"></div>
                <div style="float: left; position: relative; width: 125px;" class="auto-style1"><strong>FromDate</strong></div>
                <div style="float: left; position: relative; padding-left: 10px;">
...
<%--<div id="ChequeReceiptRegister" data-app-role="page" data-activator="Button|ChequeReceiptRegister">
  <p>
            Markup of <i>ChequeReceiptRegister</i> custom user control for Touch UI.
          </p>
</div>--%>

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="rptBankPaymentVoucher.ascx.cs" Inherits="Controls_rptBankPaymentVoucher" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <div class="ParaInfo">
            Report || Bank Payment Voucher Report. 
...
-->
<div id="rptBankPaymentVoucher" data-app-role="page" data-activator="Button|rptBankPaymentVoucher">
    <p>
        Markup of <i>rptBankPaymentVoucher</i> custom user control for Touch UI.
    </p>
</div>
...
<script type="text/javascript">
   ...
   // function myFunction() {
     //   var b = window.open("BankPaymentVoucher.pdf");
       //  b.print();
 //   }

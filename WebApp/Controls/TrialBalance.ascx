<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TrialBalance.ascx.cs" Inherits="WebApp.Controls.TrialBalance" %>
    ...
    <ContentTemplate>
        <div style="margin: 2px; padding: 8px;">
            <div id="PagesHeader" runat="server">
                ...
                <div style="border: 1pt solid #cccccc; width: 600px; padding-left: 5px;">
                    <div style="clear: both; height: 10px;"></div>
                    <div style="float: left; position: relative; width: 135px;" class="auto-style1">Select option</div>
                    <div style="float: left; position: relative; padding-left: 10px;">
                        <asp:RadioButtonList ID="RadioButtonList2" runat="server" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="RadioButtonList2_SelectedIndexChanged">
                            <asp:ListItem Text="With Opening Balance" Value="1" Selected="True"></asp:ListItem>
                            <asp:ListItem Text="Periodic" Value="2"></asp:ListItem>
                            <asp:ListItem Text="As on" Value="3"></asp:ListItem>
                    ...
                    <div id="divfrmdate" runat="server">
                        <div style="clear: both; height: 10px;"></div>
                        <div style="float: left; position: relative; width: 135px;" class="auto-style1">From Date</div>
                    ...
                    <div id="divTodate" runat="server">
                        <div style="clear: both; height: 10px;"></div>
                        <div style="float: left; position: relative; width: 135px;" class="auto-style1">To Date</div>
                        <div style="float: left; position: relative; padding-left: 20px;">
                    ...
                    <div style="clear: both; height: 10px;"></div>
                    <div style="float: left; position: relative; width: 135px;" class="auto-style1">Select Ledger Group</div>
                    <div style="float: left; position: relative; padding-left: 10px;">
                    ...
                    <div style="float: left; position: relative; width: 240px; padding-left:150px;">
            ...
            <div class="ParaHeader" id="rptHeader" runat="server">
                ...
                <i class="icon-ok icon-white"></i>Return Trial Balance
                </asp:LinkButton>
            </div>

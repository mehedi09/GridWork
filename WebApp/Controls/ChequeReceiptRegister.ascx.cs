...
public partial class Controls_ChequeReceiptRegister : System.Web.UI.UserControl
{
    ...
    public void getBankName()
    {
        ...
        SqlDataAdapter adpt = new SqlDataAdapter("  Select CoaDetailID,AccName From [CoaDetail] where IsBankNature=1 and AccFundID=" + accfundid, con);
    ...
    private DataTable getdata(int coade, DateTime start, DateTime end)
    {
        DataTable dt = new DataTable();
        ...
        {
            SqlCommand cmd = new SqlCommand("GetChequeReceiptRegister", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add("@AccFundID", SqlDbType.Int).Value = accfundid;
            cmd.Parameters.Add("@CoadetailID", SqlDbType.Int).Value = coade;
    ...
    private void showReport()
    {
        ...
        try
        {
            ...
            DataTable dt = getdata(int.Parse(ddlBankName.SelectedValue), DateTime.Parse(txtfrmDate.Text),DateTime.Parse(txtTodate.Text));
            ReportDataSource rds = new ReportDataSource("DataSet1", dt);

            ReportViewer1.LocalReport.DataSources.Add(rds);
            ReportViewer1.LocalReport.ReportPath = new DirectoryInfo(Server.MapPath("/Controls/")) + "ChequeReceipt.rdlc";

            ReportViewer1.LocalReport.Refresh();
            ReportParameter[] rptparameter = new ReportParameter[]
            {
                //new ReportParameter("accfund",accfundid.ToString(),
    ...
    protected void return_BalancheRptForm_Click(object sender, EventArgs e)
    {
        ...
        rptHeader.Visible = false;
        clear();
        Response.Redirect("~/Pages/BankWiseChequeRegister.aspx");
    }

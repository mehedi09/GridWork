<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="rptBankReceiptVoucher.ascx.cs" Inherits="Controls_rptBankReceiptVoucher" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
   <ContentTemplate>
        <div class="ParaInfo">
            Report || Bank Receipt Voucher Report. 
            <br class="Apple-interchange-newline" />
        </div>
        <div class="ParaHeader">
            &nbsp;Bank Receipt Voucher Report
        </div>
        <div id="report_form">
...
-->
<div id="rptBankReceiptVoucher" data-app-role="page" data-activator="Button|rptBankReceiptVoucher">
    <p>
        Markup of <i>rptBankReceiptVoucher</i> custom user control for Touch UI.
    </p>
</div>

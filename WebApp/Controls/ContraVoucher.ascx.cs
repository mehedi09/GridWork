...
public partial class Controls_ContraVoucher : System.Web.UI.UserControl
{
    ...
    private void VoucherTypes()
    {
        ...
        dtVchrTypes = new DataTable();
        string SQL1 = "SELECT * FROM VoucherTypes ORDER BY VchrTypeDesc ASC";
        if (conn.State == 0)
        {
            conn.Open();
        }
        ...
        DDLVoucherType.SelectedValue = pVchrTypeID.ToString();
    ...
    private void SetInitialRow()
    {
        if (dtCurrentTable == null)
        {
            ...
            dtCurrentTable.Columns.Add(new DataColumn("Amount_DR", typeof(string)));
            dtCurrentTable.Columns.Add(new DataColumn("Amount_CR", typeof(string)));
            ...
            dr["Amount_DR"] = string.Empty;
            dr["Amount_CR"] = string.Empty;
    ...
    private void SetInitialRowforEdit()
    {
        ...
        if (Gridview1.Rows.Count > 0)
        {
            for (int rowIndex = 0; rowIndex < Gridview1.Rows.Count; rowIndex++)
            {
                ...
                TextBox txt_Amount_DR = (TextBox)Gridview1.Rows[rowIndex].Cells[8].FindControl("txt_Amount_DR");
                TextBox txt_Amount_CR = (TextBox)Gridview1.Rows[rowIndex].Cells[9].FindControl("txt_Amount_CR");
                DropDownList DDLCurrency = (DropDownList)Gridview1.Rows[rowIndex].Cells[10].FindControl("DDLCurrency");
                TextBox txt_Exchange_Rate = (TextBox)Gridview1.Rows[rowIndex].Cells[11].FindControl("txt_Exchange_Rate");

                TextBox txt_Transection_Memo = (TextBox)Gridview1.Rows[rowIndex].Cells[12].FindControl("txt_Transection_Memo");
                ...
                txt_Amount_DR.Text = dtCurrentTable.Rows[rowIndex]["Amount"].ToString();
                txt_Amount_CR.Text = dtCurrentTable.Rows[rowIndex]["Amount"].ToString();
    ...
    private void SetInitialRowforDlete(int index)
    {
        ...
        for (int i = 0; i < Gridview1.Rows.Count; i++)
        {
            ...
            TextBox txt_Amount_DR = (TextBox)Gridview1.Rows[i].Cells[8].FindControl("txt_Amount_DR");
            TextBox txt_Amount_CR = (TextBox)Gridview1.Rows[i].Cells[9].FindControl("txt_Amount_CR");
            DropDownList DDLCurrency = (DropDownList)Gridview1.Rows[i].Cells[10].FindControl("DDLCurrency");
            TextBox txt_Exchange_Rate = (TextBox)Gridview1.Rows[i].Cells[11].FindControl("txt_Exchange_Rate");

            TextBox txt_Transection_Memo = (TextBox)Gridview1.Rows[i].Cells[12].FindControl("txt_Transection_Memo");
            dr = dtCurrentTable.NewRow();
            ...
            dr["Amount_DR"] = txt_Amount_DR.Text;
            dr["Amount_CR"] = txt_Amount_CR.Text;
        ...
        if (dtCurrentTable.Rows.Count > 0)
        {
            ...
            if (dtCurrentTable.Rows.Count > 0)
            {
                for (int rowIndex = 0; rowIndex < Gridview1.Rows.Count; rowIndex++)
                {
                    ...
                    txt_Amount_DR.Text = dtCurrentTable.Rows[rowIndex]["Amount_DR"].ToString();
                    txt_Amount_CR.Text = dtCurrentTable.Rows[rowIndex]["Amount_CR"].ToString();
                    DDLCurrency.SelectedValue = dtCurrentTable.Rows[rowIndex]["Currency"].ToString();
                    txt_Exchange_Rate.Text = dtCurrentTable.Rows[rowIndex]["Exchange_Rate"].ToString();
                    txt_Transection_Memo.Text = dtCurrentTable.Rows[rowIndex]["Transection_Memo"].ToString();
    ...
    private void AddNewRowToGrid()
    {
        ...
        if (dtCurrentTable != null)
        {
            ...
            if (dtCurrentTable.Rows.Count > 0)
            {
                dVtotal = Convert.ToDecimal(txtVchrTotal.Text);
                for (int i = 0; i < dtCurrentTable.Rows.Count; i++)
                {
                    ...
                    dtCurrentTable.Rows[i]["Amount_DR"] = txt_Amount_DR.Text;
                    dtCurrentTable.Rows[i]["Amount_CR"] = txt_Amount_CR.Text;
    ...
    private void SetPreviousData()
    {
        ...
        int rowIndex = 0;
        int lastRow = 0;
        lastRow = dtCurrentTable.Rows.Count - 1;
        ...
        if (dtCurrentTable != null)
        {
            if (dtCurrentTable.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < dtCurrentTable.Rows.Count; i++)
                {
                    ...
                    txt_Amount_DR.Text = dtCurrentTable.Rows[i]["Amount_DR"].ToString();
                    txt_Amount_CR.Text = dtCurrentTable.Rows[i]["Amount_CR"].ToString();
                    if (lastRow == rowIndex)
                    {
                        txt_Amount_CR.Text = dVtotal.ToString();
                    }
    ...
    private void Voucher_Type_Wise_Design()
    {
        ...
        tr_for_CashPayment6.Visible = true;
        ...
        if (VoucherTypeCode == "JV")
        {
            ...
            tr_for_CashPayment6.Visible = false;
        }
    }
    ...
    private void Total_Ammount_Calculation()
    {
        ...
        {
            TextBox txt_Amount_DR = (TextBox)Gridview1.Rows[irow - 1].Cells[8].FindControl("txt_Amount_DR");
            TextBox txt_Amount_CR = (TextBox)Gridview1.Rows[irow - 1].Cells[9].FindControl("txt_Amount_CR");


            if (txt_Amount_DR.Text == "")
            {
                Total = 0;
            ...
            {
                Total = Convert.ToDecimal(txt_Amount_DR.Text.Trim());
                Sum_Total = Sum_Total + Total;
            }
        ...
        if (dtCurrentTable != null)
        {
            ...
            try
            {
                ...
                for (int irows = 1; Gridview1.Rows.Count >= irows; irows++)
                {
                    ...
                    TextBox txt_Amount_DR = (TextBox)Gridview1.Rows[irows - 1].Cells[8].FindControl("txt_Amount_DR");
                    TextBox txt_Amount_CR = (TextBox)Gridview1.Rows[irows - 1].Cells[9].FindControl("txt_Amount_CR");
                    DropDownList DDLCurrency = (DropDownList)Gridview1.Rows[irows - 1].Cells[10].FindControl("DDLCurrency");
                    TextBox txt_Exchange_Rate = (TextBox)Gridview1.Rows[irows - 1].Cells[11].FindControl("txt_Exchange_Rate");
                    TextBox txt_Transection_Memo = (TextBox)Gridview1.Rows[irows - 1].Cells[12].FindControl("txt_Transection_Memo");
                    #endregion
                    ...
                    dtCurrentTable.Rows[irows - 1]["Amount_DR"] = txt_Amount_DR.Text;
                    dtCurrentTable.Rows[irows - 1]["Amount_CR"] = txt_Amount_CR.Text;
                    ...
                    if (AccVoucherTranID == 0)
                    {
                        ...
                        {
                            cmd.Parameters.Add("@RevAcc", SqlDbType.Int).Value = DBNull.Value;
                        }
                        ...
                        {
                            cmd.Parameters.Add("@AccSubCode1", SqlDbType.Int).Value = (dtCurrentTable.Rows[irows - 1]["Sub_Ledger1"]);
                        }
                        int AccSubTypeID2 = 0;
                        if (string.IsNullOrEmpty(dtCurrentTable.Rows[irows - 1]["Sub_Type1"].ToString()))
                        {
                        ...
                        {
                            cmd.Parameters.Add("@AccSubCode2", SqlDbType.Int).Value = (dtCurrentTable.Rows[irows - 1]["Sub_Ledger2"]);
                        }

                        if (headerinfo[8] == "CP" || headerinfo[8] == "BP")// Cash or Bank Payment
                        {
                            cmd.Parameters.Add("@DebitAmt", SqlDbType.Money).Value = dtCurrentTable.Rows[irows - 1]["Amount_DR"];//@DebitAmt Money,--
                            cmd.Parameters.Add("@CreditAmt", SqlDbType.Money).Value = 0;

                            a = Convert.ToDouble(dtCurrentTable.Rows[irows - 1]["Amount_DR"]);
                            Result = (a + Result);
                        ...
                        else if (headerinfo[8] == "CR" || headerinfo[8] == "BR" || headerinfo[8] == "TV")
                        {
                            ...
                            cmd.Parameters.Add("@CreditAmt", SqlDbType.Money).Value = dtCurrentTable.Rows[irows - 1]["Amount_DR"];//dtCurrentTable.Rows[irows - 1]["Amount"];  //@DebitAmt Money,--
                            if (!string.IsNullOrEmpty(dtCurrentTable.Rows[irows - 1]["Amount_DR"].ToString()))
                            {
                                a = Convert.ToDouble(dtCurrentTable.Rows[irows - 1]["Amount_DR"]);
                                Result = (a + Result);
                            }
                        ...
                        {
                            cmd.Parameters.Add("@DebitAmt", SqlDbType.Money).Value = Convert.ToDecimal("0" + dtCurrentTable.Rows[irows - 1]["Amount_DR"]);//@DebitAmt Money,--
                            cmd.Parameters.Add("@CreditAmt", SqlDbType.Money).Value = Convert.ToDecimal("0" + dtCurrentTable.Rows[irows - 1]["Amount_CR"]);  //@DebitAmt Money,--
                        ...
                        {
                            PopUp("Voucher Saving Error..." + ex.Message);
                        }
                        #endregion
                    }
                    else
                    {
                        ...
                        {
                            cmd.Parameters.Add("@DebitAmt", SqlDbType.Money).Value = 0; //@DebitAmt Money,--
                            cmd.Parameters.Add("@CreditAmt", SqlDbType.Money).Value = dtCurrentTable.Rows[irows - 1]["Amount_DR"];  //@DebitAmt Money,--
                            a = Convert.ToDouble(dtCurrentTable.Rows[irows - 1]["Amount_DR"]);
                            Result = (a + Result);
                            cmd.Parameters.Add("@IsRevtran", SqlDbType.Int).Value = 0;      //@IsRevtran int,--0
                        }
                    ...
                    if (irows == LastRow)
                    {
                        ...
                        if (VoucherTypeCode != "JV")
                        {
                            cmd.Parameters.Add("@HeadAcc", SqlDbType.Int).Value = Convert.ToInt64(headerinfo[5]);
                            cmd.Parameters.Add("@RevAcc", SqlDbType.Int).Value = Convert.ToInt64(dtCurrentTable.Rows[LastRow - 1]["Transection_Ledger"]);
                        }
                        else
                        {
                            cmd.Parameters.Add("@HeadAcc", SqlDbType.Int).Value = Convert.ToInt64(dtCurrentTable.Rows[LastRow - 1]["Transection_Ledger"]);
                            cmd.Parameters.Add("@RevAcc", SqlDbType.Int).Value = DBNull.Value;
                        }
                        ...
                        {
                            cmd.Parameters.Add("@AccSubCode", SqlDbType.Int).Value = (dtCurrentTable.Rows[LastRow - 1]["Sub_Ledger"]);//@AccSubCode int,
                        }
                        else
                        {
                        ...
                        {
                            cmd.Parameters.Add("@AccSubCode1", SqlDbType.Int).Value = (dtCurrentTable.Rows[LastRow - 1]["Sub_Ledger1"]);//@AccSubCode int,
                        }
                        else
                        {
                        ...
                        {
                            cmd.Parameters.Add("@AccSubCode2", SqlDbType.Int).Value = (dtCurrentTable.Rows[LastRow - 1]["Sub_Ledger2"]);//@AccSubCode int,
                        }
                        else
                        {
    ...
    protected void Find_Voucher_Data(object sender, EventArgs e)
    {
        try
        {
            ...
            pVchrTypeID = Convert.ToInt32(DDLVoucherType_Find.SelectedValue);
            VoucherTypeRead();
            ...
            SQL += " ORDER BY [AccVoucherTranID] DESC";
    ...
    protected void Gridview1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            //TextBox txt_Amount_DR = (TextBox)e.Row.FindControl("txt_Amount_DR");
            //TextBox txt_Amount_CR = (TextBox)e.Row.FindControl("txt_Amount_CR");
            if (dtCurrentTable.Rows[e.Row.RowIndex]["Old_Data"] == "1")
            {
                DDLT_Ledger.Enabled = false;
                //DDLS_Ledger.Enabled = false;
                // txt_Amount_DR.Enabled = false;
                // txt_Amount_CR.Enabled = false;

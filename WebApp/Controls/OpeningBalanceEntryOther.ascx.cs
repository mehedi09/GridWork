...
public partial class Controls_OpeningBalanceEntryOther : System.Web.UI.UserControl
{
    ...
    {
        con = new SqlConnection(conr);
        SqlDataAdapter adpt = new SqlDataAdapter("select AccSubTypeID,AccSubTypeName from AccsubTypes where AccSubTypeID Not in(1,3,4)", con);
    ...
    {
        SqlDataAdapter da = new SqlDataAdapter("Select CoaDetailID,AccName,ISNULL(OpenDebit,0)OpenDebit,ISNULL(OpenCredit,0)OpenCredit from [CoaDetail] where AccSubTypeID='" + SubTypeID + "'", con);

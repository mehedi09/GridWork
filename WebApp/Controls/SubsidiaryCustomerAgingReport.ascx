<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SubsidiaryCustomerAgingReport.ascx.cs" Inherits="Controls_SubsidiaryCustomerAgingReport" %>
        ...
        <div style="margin: 2px; padding: 8px;">
            <div id="PagesHeader" runat="server">
                ...
                <div style="border: 1px solid #cccccc; width: 350px; padding-left: 5px;">
                    ...
                    <div style="float: left; position: relative; width: 125px;" class="auto-style1">Customer Ledger </div>
            ...
            <div class="ParaHeader" id="rptHeader" runat="server">
                ...
                <i class="icon-ok icon-white"></i>Subsidiary Customer Aging Reprot 
                </asp:LinkButton>
            </div>

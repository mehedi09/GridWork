...
public partial class Controls_ChequeBookWiseChequeRegister : System.Web.UI.UserControl
{
    ...
    private DataTable getdata(int Bankcode, DateTime start, DateTime end, int accfund)
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("USP_ChequeBookChequelist", con);
    ...
    private void showReport()
    {
        ...
        try
        {
            ...
            ReportViewer1.LocalReport.ReportPath = new DirectoryInfo(Server.MapPath("/Controls/")) + "ChequeBookWiseChequeRegister.rdlc";
            ...
            fileName = "ChequeBookWiseChequeRegister" + DateTime.Now.ToFileTime() + ".pdf";
    ...
    protected void return_BalancheRptForm_Click(object sender, EventArgs e)
    {
        ...
        rptHeader.Visible = false;
        clear();
        Response.Redirect("~/Pages/ChequeBookWiseChequeRegister.aspx");

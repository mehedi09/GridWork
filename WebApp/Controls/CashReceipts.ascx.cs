...
public partial class Controls_CashReceipts : System.Web.UI.UserControl
{
    ...
    private void VoucherTypes()
    {
        ...
        dtVchrTypes = new DataTable();
        string SQL1 = "SELECT * FROM VoucherTypes WHERE VchrTypeID = " + pVchrTypeID + " ORDER BY VchrTypeDesc ASC";
        if (conn.State == 0)
        {
            conn.Open();
        }
    ...
    protected void Print_Voucher(object sender, EventArgs e)
    {
        ...
        if (IsExitsPDF)
        {
            ...
            try
            {
                ...
                string ReportPath = new DirectoryInfo(HttpContext.Current.Server.MapPath("/Controls/")) + "CashReciptVoucher.rdlc";
                ...
                ReportParameter[] rptparameter = new ReportParameter[]
            {
                ...
                fileName = "CashReciptVoucher" + DateTime.Now.ToFileTime() + ".pdf";

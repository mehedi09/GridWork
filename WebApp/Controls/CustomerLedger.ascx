<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CustomerLedger.ascx.cs" Inherits="Controls_CustomerLedger"  %>
...
<%--            <div id="Div1" runat="server">--%>
             ...
             <div style ="border:1px solid #cccccc;width:350px;padding-left:5px;">
                ...
                <div style="float: left; position: relative; width: 125px; top: 0px; left: 0px; height: 18px;" class="auto-style1">Customer Ledger</div>
                <div style="float: left; position: relative; padding-left: 10px;">
                    <asp:DropDownList ID="ddlACCCode" runat="server"   Width="200" OnSelectedIndexChanged="ddlAccSubCode_SelectedIndexChanged" AutoPostBack="True"  >
                    </asp:DropDownList>
            ...
            <div style="float: left; position: relative; padding-left: 10px;">
                <asp:DropDownList ID="ddlAccSubCode" runat="server" Width="200px"  AutoPostBack="True">
               ...
               <%-- <asp:DropDownList ID="DropDownList1" runat="server" Width="200px"  AutoPostBack="True"></asp:DropDownList>--%>
                ...
                <div style="clear: both; height: 10px;"></div>
                 ...
                 <div style="float: left; position: relative; width: 90px;" class="auto-style1"> </div>
                  <div style="float: left; position: relative; padding-left: 135px;">
                   <asp:Button ID="Button2" runat="server" Text="Show Report" OnClick="Button1_Click1" />
                </div>
           ...
           <div class="ParaHeader" id="rptHeader" runat="server">
             <asp:LinkButton ID="return_BalancheRptForm" runat="server" CssClass="btn btn-info" Style="margin-left:40%" OnClick="return_BalancheRptForm_Click">
                <i class="icon-ok icon-white"></i>Return Customer Ledger 
            </asp:LinkButton>
           </div>

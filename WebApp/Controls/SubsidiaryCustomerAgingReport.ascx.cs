...
public partial class Controls_SubsidiaryCustomerAgingReport : System.Web.UI.UserControl
{
    ...
    private void showReport()
    {
        ...
        try
        {
            ...
            ReportViewer1.LocalReport.ReportPath = new DirectoryInfo(Server.MapPath("/Controls/")) + "SubsidiaryCustomerAgingReport.rdlc";
            ...
            fileName = "SubsidiaryCustomerAgingReport" + DateTime.Now.ToFileTime() + ".pdf";
    ...
    protected void return_BalancheRptForm_Click(object sender, EventArgs e)
    {
        ...
        rptHeader.Visible = false;
        clear();
        Response.Redirect("~/Pages/SubsidiaryCustomerAgingReport.aspx");
    }
}

...
public partial class Controls_rptCashReceiptVoucher : System.Web.UI.UserControl
{
    ...
    private void VoucherTypes()
    {
        ...
        conn.Open();
        string SQL1 = "SELECT * FROM VoucherTypes WHERE VchrTypeID = 2 ORDER BY VchrTypeDesc ASC";
    ...
    protected void Show_Report(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ReportDataSource rds = new ReportDataSource("CR_Data_GetVoucherPrintIpac", dt);
            ReportViewer1.LocalReport.DataSources.Add(rds);

            string ReportPath = new DirectoryInfo(HttpContext.Current.Server.MapPath("~/")).Parent.FullName + "\\MyCompany\\Reports\\CashReceiptVoucher.rdlc";

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SupplierLedger.ascx.cs" Inherits="Controls_SupplierLedger" %>
        ...
        <div style="margin: 2px; padding: 8px;">
            <div id="PagesHeader" runat="server">
                ...
                <div style="border: 1px solid #cccccc; width: 400px; padding-left: 5px;">
                    ...
                    <div style="float: left; position: relative; width: 125px;" class="auto-style1">Supllier Ledger </div>
                    <div style="float: left; position: relative; padding-left: 10px;">
                        <asp:DropDownList ID="ddlAccSubCode" runat="server" Width="200" OnSelectedIndexChanged="ddlAccSubCode_SelectedIndexChanged" AutoPostBack="True">
                        </asp:DropDownList><%--<asp:CheckBox ID="chkAll" checked="true" runat="server" Text="All" AutoPostBack="True" OnCheckedChanged="chkAll_CheckedChanged" />--%>
                    </div>
            ...
            <div class="ParaHeader" id="rptHeader" runat="server">
                ...
                <i class="icon-ok icon-white"></i>Return Supplier Ledger 
                </asp:LinkButton>
            </div>

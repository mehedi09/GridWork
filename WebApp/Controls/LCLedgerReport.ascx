<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LCLedgerReport.ascx.cs" Inherits="Controls_LCLedgerReport"  %>
        ...
        <div style="margin: 2px; padding: 8px;">
            ...
            <div id="PagesHeader" runat="server">
             ...
             <div style ="border:1px solid #cccccc;width:350px;padding-left:5px;">
                ...
                <div style="float: left; position: relative; width: 90px;font-family:'Arial Unicode MS'" class="auto-style1">Ledger Type</div>
            ...
            <div class="ParaHeader" id="rptHeader" runat="server">
                ...
                <i class="icon-ok icon-white"></i>Return LC Ledger Report 
                </asp:LinkButton>
            </div>

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CashPayment.ascx.cs" Inherits="Controls_CashPayment" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server"  >
    <ContentTemplate>
        ...
        <div class="ParaHeader">
            ...
            <asp:LinkButton ID="LB_Voucher_Print" runat="server" CssClass="btn btn-info" Style="margin-left: 35%;" OnClick="Print_Voucher">
            ...
            <div id="VC_Form" runat="server">
                ...
                <div class="ParaHeader" align="center">
                 ...
                 <asp:Button ID="btn_Cancel" runat="server" Text="New" CssClass="btn" OnClick="Cancel_Voucher"
                     Height="23px" Width="87px" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="btn_delete" runat="server" Text="Cancel Voucher"  CssClass="btn" OnClick="Delete_Voucher"
                        Height="23px" Width="90px" OnClientClick="return confirm('Are you certain you want to delete this voucher?');"  />

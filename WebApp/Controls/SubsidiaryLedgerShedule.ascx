<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SubsidiaryLedgerShedule.ascx.cs" Inherits="Controls_SubsidiaryLedgerShedule" %>
    ...
    <ContentTemplate>
        <div style="margin: 2px; padding: 8px;">
            ...
            <div class="ParaHeader" id="rptHeader" runat="server">
                ...
                <i class="icon-ok icon-white"></i>Return Supplier Trial balance 
                </asp:LinkButton>
            </div>

...
/// </summary>
public partial class Controls_BankPayment : System.Web.UI.UserControl
{
            ...
            try
            {
                ...
                for (int irows = 1; Gridview1.Rows.Count >= irows; irows++)
                {
                    ...
                    if (AccVoucherTranID == 0)
                    {
                        ...
                        {
                            cmd.Parameters.Add("@AccSubCode1", SqlDbType.Int).Value = Convert.ToInt64((dtCurrentTable.Rows[irows - 1]["Sub_Ledger1"]));
                        }
                        int AccSubTypeID2 = 0;
                        if (string.IsNullOrEmpty(dtCurrentTable.Rows[irows - 1]["Sub_Type1"].ToString()))
                        {

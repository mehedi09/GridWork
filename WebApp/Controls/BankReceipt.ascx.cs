...
public partial class Controls_BankRecipt : System.Web.UI.UserControl
{
    ...
    protected void Print_Voucher(object sender, EventArgs e)
    {
        ...
        if (IsExitsPDF)
        {
            ...
            try
            {
                ...
                string ReportPath = new DirectoryInfo(HttpContext.Current.Server.MapPath("/Controls/")) + "BankReceiptVoucher.rdlc";
                ...
                ReportParameter[] rptparameter = new ReportParameter[]
            {
                ...
                fileName = "BankReceiptVoucher" + DateTime.Now.ToFileTime() + ".pdf";

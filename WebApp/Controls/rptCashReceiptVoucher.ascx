<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="rptCashReceiptVoucher.ascx.cs" Inherits="Controls_rptCashReceiptVoucher" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
      <ContentTemplate>
       <ContentTemplate>
        <div class="ParaInfo">
            Report || Cash Receipt Voucher Report. 
            <br class="Apple-interchange-newline" />
        </div>
        <div class="ParaHeader">
            &nbsp;Cash Receipt Voucher Report
        </div>
        <div id="report_form">
...
-->
<div id="rptCashReceiptVoucher" data-app-role="page" data-activator="Button|rptCashReceiptVoucher">
    <p>
        Markup of <i>rptCashReceiptVoucher</i> custom user control for Touch UI.
    </p>
</div>

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SubLedgerByGroup.ascx.cs" Inherits="Controls_SubLedgerByGroup" %>
<!-- 
    ...
    <ContentTemplate>
        <div style="margin: 2px; padding: 8px;">
            <div id="PagesHeader" runat="server">
                ...
                <div style="border: 1px solid #cccccc; width: 400px; padding-left: 5px;">
                    <div style="clear: both; height: 10px;"></div>
                    <div style="float: left; position: relative; width: 125px;font-family:'Arial Unicode MS';" class="auto-style1">Analysis Group </div>
                    <div style="float: left; position: relative; padding-left: 10px;">
                        <asp:DropDownList ID="ddlAnalysis" runat="server" Width="200" AutoPostBack="True" OnSelectedIndexChanged="ddlAnalysis_SelectedIndexChanged">
                        </asp:DropDownList>
                    </div>
                    ...
                    <div style="clear: both; height: 10px;"></div>
                    <div style="float: left; position: relative; width: 125px;font-family:'Arial Unicode MS'" class="auto-style1">Ledger Account </div>
                    <div style="float: left; position: relative; padding-left: 10px;">
                    ...
                    <div style="clear: both; height: 10px;"></div>
                    <div style="float: left; position: relative; width: 125px;font-family:'Arial Unicode MS'" class="auto-style1">From Date</div>
                    <div style="float: left; position: relative; padding-left: 10px;">
                    ...
                    <div style="clear: both; height: 10px;"></div>
                    <div style="float: left; position: relative; width: 125px;font-family:'Arial Unicode MS'" class="auto-style1">To Date</div>
                    <div style="float: left; position: relative; padding-left: 10px;">
                    ...
                    <div style="float: left; position: relative; width: 90px;" class="auto-style1"></div>
            ...
            <div class="ParaHeader" id="rptHeader" runat="server">
                ...
                <i class="icon-ok icon-white"></i>Return Sub Ledger By Group
                </asp:LinkButton>
            </div>

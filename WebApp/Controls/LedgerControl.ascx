<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LedgerControl.ascx.cs" Inherits="Controls_LedgerControl" %>
        ...
        <div style="margin: 2px; padding: 8px;">
            <%--<div id="PagesHeader" runat="server">
                ...
                <div style="border: 1px solid #cccccc; width: 350px; padding-left: 5px;">
                    ...
                    <div style="float: left; position: relative; width: 150px;" class="auto-style1"><strong>Ledger :</strong></div>
                    <div style="float: left; position: relative; width: 200px; padding-left: 10px;">
                        <asp:DropDownList ID="ddlLedger" Width="200px" runat="server"></asp:DropDownList>
                    </div>
                    <div style="float: left; position: relative;">
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" ControlToValidate="ddlLedger" InitialValue="--Select Company Name--" ToolTip="Please Select Account Fund code " ForeColor="Red">*</asp:RequiredFieldValidator>
            ...
            <div id="PagesHeader" runat="server">
             ...
             <div style ="border:1px solid #cccccc;width:350px;padding-left:5px;">
                ...
                <div style="clear: both; height: 10px;"></div>
                <div style="float: left; position: relative; width: 90px;font-family:'Arial Unicode MS'" class="auto-style1">Ledger : </div>
                <div style="float: left; position: relative; padding-left: 10px;">
                    <asp:DropDownList ID="ddlLedger" runat="server" Width="200px" AutoPostBack="True">
                    </asp:DropDownList>
            ...
            <div class="ParaHeader" id="rptHeader" runat="server">
                ...
                <i class="icon-ok icon-white"></i>Return Ledger Control 
                </asp:LinkButton>
            </div>

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChequeBookWiseChequeRegister.ascx.cs" Inherits="Controls_ChequeBookWiseChequeRegister"  %>
    ...
    <ContentTemplate>
        <div style="margin: 2px; padding: 8px;">
            <div id="PagesHeader" runat="server">
             ...
             <div style ="border:1px solid #cccccc;width:380px;padding-left:5px;">
                ...
                <div style="float: left; position: relative; padding-left: 10px;">
                    <asp:DropDownList ID="ddlBankName" runat="server" Width="240px">
                    </asp:DropDownList>

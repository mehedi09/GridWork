<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JournalVoucher.ascx.cs" Inherits="Controls_JournalVoucher" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <div class="ParaInfo">
            Journal Voucher Form, Here You Create Journal Voucher.
                            ...
                            <td valign="top">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style1">
                                            <div class="FieldPlaceholder DataOnly">
                                                <asp:DropDownList ID="DDLTranLedger" runat="server" Style="width: 220px" AutoPostBack="true" OnSelectedIndexChanged="DDLTranLedger_SelectedIndexChanged">
                                                </asp:DropDownList>
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        <td>Head of Account's Sub Ledger :</td>
                                        <td>
                                            <asp:DropDownList ID="DDLSub_Ledger_TranLedger" runat="server" Style="width: 220px">
                                            </asp:DropDownList></td>
                                    </tr>
                                     <tr>
                                        <td colspan="2"></td>
                    ...
                    <asp:GridView ID="GV_JournalVoucher" runat="server" ShowFooter="true" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Head of Account">
                                <ItemTemplate>
                                    <div>
                                        <asp:DropDownList ID="DDLTransection_Ledger" runat="server"  AutoPostBack="true" OnSelectedIndexChanged="DDLTransection_Ledger_SelectedIndexChanged" Style="width: 100%">
                                        </asp:DropDownList>
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Amount">
                                <ItemTemplate>
                                    <div class="RightAlignedInputs" align="center">
                                        <asp:TextBox ID="txt_Amount" runat="server" Style="width: 90%" onkeypress = "javascript:return ValidateNmber(this,event);"></asp:TextBox>
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChequeUtilizationSummary.ascx.cs" Inherits="Controls_ChequeUtilizationSummary"  %>
    ...
    <ContentTemplate>
     ...
     <div id="PagesHeader" runat="server">
             ...
             <div style ="border:1px solid #cccccc;width:400px;padding-left:5px;">
                ...
                <div style="float: left; position: relative; width: 90px;font-family:'Arial Unicode MS'" class="auto-style1">Bank Name </div>
                <div style="float: left; position: relative; padding-left: 10px;">
                    <asp:DropDownList ID="ddlCoaDetail" runat="server" Width="240px" AutoPostBack="True">
                    </asp:DropDownList>

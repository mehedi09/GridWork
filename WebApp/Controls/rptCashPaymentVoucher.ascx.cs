...
public partial class Controls_rptCashPaymentVoucher : System.Web.UI.UserControl
{
    ...
    protected void Show_Report(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string ReportPath = new DirectoryInfo(HttpContext.Current.Server.MapPath("~/")).Parent.FullName + "\\MyCompany\\Reports\\CashPaymentVoucher.rdlc";

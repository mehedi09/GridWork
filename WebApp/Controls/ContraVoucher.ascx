<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ContraVoucher.ascx.cs" Inherits="Controls_ContraVoucher"  %>
                        ...
                        <tr>
                            <td valign="top">
                                <table>
                                    ...
                                    <tr class="FieldWrapper" runat="server">
                                        <td class="Header" valign="top">Company Name:
                                        </td>
                                        <td class="auto-style1">
                                            <div class="FieldPlaceholder DataOnly">
                                                <asp:DropDownList ID="DDLCompany_Name_Find" runat="server" Style="width: 210px" OnSelectedIndexChanged="DDLCompany_Name_Find_SelectedIndexChanged" AutoPostBack="true">
                                                </asp:DropDownList>
                            ...
                            <td valign="top">
                                <table>
                                    ...
                                    <tr runat="server" id="tr_Cash_Bank">
                                        <td class="Header" valign="top">Fund Source Account :
                                        </td>
                                        <td>
                                    ...
                                    <tr id="tr_for_CashPayment6" runat="server">
                                        <td>Paid To :</td>
                                        <td>
                                            <div class="FieldPlaceholder DataOnly">
                ...
                <div class="ParaHeader" align="center">
                 ...
                 <asp:Button ID="btn_Cancel" runat="server" Text="New" CssClass="btn" OnClick="Cancel_Voucher"
                    ...
                    <asp:Button ID="btn_delete" runat="server" Text="Cancel Voucher" Visible="false" CssClass="btn" OnClick="Delete_Voucher"
                        Height="23px" Width="87px" OnClientClick="return confirm('Are you certain you want to delete this voucher?');" />
                </div>
                    ...
                    <asp:GridView ID="Gridview1"  runat="server" ShowFooter="true" AutoGenerateColumns="false" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Amount" >
                                <ItemTemplate>
                                    <div class="RightAlignedInputs" align="center">
                                        <asp:TextBox ID="txt_Amount_DR" runat="server" Style="width: 90%" AutoPostBack="true" OnTextChanged="txt_Amount_TextChanged"></asp:TextBox>
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Credit" Visible="false">
                                <ItemTemplate>
                                    <div class="RightAlignedInputs" align="center">
                                        <asp:TextBox ID="txt_Amount_CR" runat="server" Style="width: 90%" AutoPostBack="true" OnTextChanged="txt_Amount_TextChanged"></asp:TextBox>
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
